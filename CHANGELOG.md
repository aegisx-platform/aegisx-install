...
* **inventory:** ใบเบิกกดผิดจังหวะต้องบอกเหตุผลไทย ไม่ใช่ 500 ([43f9040](https://github.com/aegisx-platform/aegisx-starter/commit/43f9040b1b5377bf2e7de62d90f0471a87852f92))
...
* **procurement-tracker:** fiscal-year dropdown from config not the clock ([f42ceec](https://github.com/aegisx-platform/aegisx-starter/commit/f42ceecb163f7584689564dcae26000153b9ad30))
* **procurement-tracker:** make list/counts search actually filter (PR/PO/vendor) ([6e7050e](https://github.com/aegisx-platform/aegisx-starter/commit/6e7050ec002559d8cd1af50d7a94282bbae16359))
* **procurement-tracker:** send button auto-walks DRAFT/PENDING PO to SENT ([b4d9c66](https://github.com/aegisx-platform/aegisx-starter/commit/b4d9c66a01dba66dc56d989b89dd2f118d6d0492))
* **procurement-tracker:** unsend sends required reason to revert-to-draft ([510e310](https://github.com/aegisx-platform/aegisx-starter/commit/510e310ea4f512f5098aaa9cd38b51deec134316))
* **procurement-workspace:** รายการยาโชว์ชื่อการค้าเป็นหลัก generic เป็นรอง ([68490cd](https://github.com/aegisx-platform/aegisx-starter/commit/68490cd7a86429df6ff32834e21fbca9261ae720))
* **procurement:** harden tracker — [@if](https://github.com/if), safe milestone default, cancel 10-500 ([26f540c](https://github.com/aegisx-platform/aegisx-starter/commit/26f540c032443f680edf41242c3fd80838e47930))
* **procurement:** row 'ออก PO' attaches PO to existing PR, not a new one ([3df9fb6](https://github.com/aegisx-platform/aegisx-starter/commit/3df9fb64d8eda37caa96b25456b56b4243aa8103))
* **procurement:** กัน PR เก็บ budget allocation เก่าเมื่อเปลี่ยนหน่วยงาน/ปีงบ (PR [#405](https://github.com/aegisx-platform/aegisx-starter/issues/405) review) ([96629ba](https://github.com/aegisx-platform/aegisx-starter/commit/96629bab9e49b601ed1bf7eaeba3d8bcb50e8434))
* **tracker:** default ปีงบเป็นปีปัจจุบันเสมอ (fallback /current เมื่อไม่มี is_current) ([c0bec8e](https://github.com/aegisx-platform/aegisx-starter/commit/c0bec8edb20a471f602647aef54e72c81af5232e))
* **tracker:** detail dialog ใช้ mat-dialog มาตรฐาน aegisx (header + padding) ([9b05045](https://github.com/aegisx-platform/aegisx-starter/commit/9b05045601fbc9b005811e2d3969ceb5ae8d40eb))
* **tracker:** filter โชว์ค่า "ทั้งหมด" ในช่อง (ใช้ sentinel แทน null ที่ mat-select ล้างทิ้ง) ([844f2ab](https://github.com/aegisx-platform/aegisx-starter/commit/844f2ab5a9d1aaf4f95b4f695e9ee1a806c01ed2))
* **tracker:** กดปลดล็อก/แก้ไข ทีเดียวเปิด workspace เลย + icon เมนู ⋮ ([67317d3](https://github.com/aegisx-platform/aegisx-starter/commit/67317d3e1b8299a8d5dc0accff86c1013970f6df)), closes [#405](https://github.com/aegisx-platform/aegisx-starter/issues/405)
* **tracker:** ส่ง revert_reason ตอนปลดล็อกใบขอซื้อ (แก้ 400) ([734e97f](https://github.com/aegisx-platform/aegisx-starter/commit/734e97fd87c0dddcd903cd19fbf65515cd19c7af))
* **workspace:** footer เต็มความกว้าง ปุ่ม action ชิดขวาสุด ([b698eff](https://github.com/aegisx-platform/aegisx-starter/commit/b698eff85fade943cec11d71a202afec132265f7))
* **workspace:** refresh ยอดรวม + PO หลัง cascade แก้รายการยา ([447a83e](https://github.com/aegisx-platform/aegisx-starter/commit/447a83e500054a4dced0f5bfc71a4eadc01aa7a1))
* **workspace:** ย้ายปุ่ม action ลง mat-dialog-actions + surface เต็มจอไม่เหลือช่องว่าง ([21180aa](https://github.com/aegisx-platform/aegisx-starter/commit/21180aa3d45d3bfc52b8d53482bd4dd89f76696b))


### Features

* **po:** dialog สร้าง PO จาก PR ใช้ item row แบบเดียวกับฟอร์ม PR ([b2438b0](https://github.com/aegisx-platform/aegisx-starter/commit/b2438b0f7f61498a44b846e5c65cc747c7541292))
* **pr:** expose latest_po_status + vendor in list for tracker ([5b11daf](https://github.com/aegisx-platform/aegisx-starter/commit/5b11daf46ba7efe6c855e44f2057874cc99cad3a))
* **procurement-tracker:** add full create-button set from the PR page ([449a526](https://github.com/aegisx-platform/aegisx-starter/commit/449a526c4717a8080cd3964aaec2f9f2724d6147))
* **procurement-tracker:** add สัญญา (contract) badge column per row ([253a261](https://github.com/aegisx-platform/aegisx-starter/commit/253a2617bfcff4eafafad8a5151fb6737ae135ff))
* **procurement-tracker:** click สัญญา badge to open contract view dialog ([e6fc50a](https://github.com/aegisx-platform/aegisx-starter/commit/e6fc50aa8b5c31df81e45007c101d54612c9337c))
* **procurement-tracker:** print PR document like the PR page ([4f8d6c1](https://github.com/aegisx-platform/aegisx-starter/commit/4f8d6c1a1a919dfc7ec15f7af877df11e7df95a0))
* **procurement-tracker:** show unit in the amount breakdown ([c7ebf65](https://github.com/aegisx-platform/aegisx-starter/commit/c7ebf65b99efc418b625058eae2b0a27cd054651))
* **procurement-tracker:** slice 1 row visuals matching mockup ([f758651](https://github.com/aegisx-platform/aegisx-starter/commit/f7586516d4f0684ed7779b0954afa865ebfa93d7))
* **procurement-tracker:** slice 2a search and fiscal-year filter ([979a078](https://github.com/aegisx-platform/aegisx-starter/commit/979a0781e7934f9358534edfb95b8f6f75d9c668))
* **procurement-tracker:** slice 2b-1 milestone filter chips with counts ([204222d](https://github.com/aegisx-platform/aegisx-starter/commit/204222de50d7332c5bfa5583a26f623eb2d247e1))
* **procurement-tracker:** slice 2b-2 vendor filter dropdown ([af44a4b](https://github.com/aegisx-platform/aegisx-starter/commit/af44a4bfb013011a033befa3d4b824875dfdf545))
* **procurement-tracker:** slice 3 zone header + default current fiscal year ([896b60c](https://github.com/aegisx-platform/aegisx-starter/commit/896b60c643c77159fa9a23a8dea130fedd09fa16))
* **procurement-tracker:** slice 4 row-click detail workspace dialog ([3e891f3](https://github.com/aegisx-platform/aegisx-starter/commit/3e891f35c3535b5df5737f592d76aa76e18d1891))
* **procurement-tracker:** split PO approve/send into 5 visible milestones ([34bce3a](https://github.com/aegisx-platform/aegisx-starter/commit/34bce3ac407e8572205ff0ad1fc3fbb346f2e0c6))
* **procurement-tracker:** unit-price breakdown under the amount cell ([7e4f325](https://github.com/aegisx-platform/aegisx-starter/commit/7e4f3252a293f399bdbf818498610f6583fcd39f))
* **procurement-workspace:** slice 1 — workspace shell read-only 2 zones ([cfb0566](https://github.com/aegisx-platform/aegisx-starter/commit/cfb05661c8a939f6d3dca7e0a7b4915a84e8c97e))
* **procurement-workspace:** slice 2 — shared identity band (read-only) ([69c7f7d](https://github.com/aegisx-platform/aegisx-starter/commit/69c7f7d33966f28406dda60399d59f68761c2560))
* **procurement-workspace:** slice 2 — ตารางรายการยา PR แก้ inline ([56bd2d9](https://github.com/aegisx-platform/aegisx-starter/commit/56bd2d93196638d1487fe6e198b346e64436801b))
* **procurement-workspace:** slice 3 — PR zone inline edit + save ([721c5ac](https://github.com/aegisx-platform/aegisx-starter/commit/721c5acc117b3b03f17b825f2959a78fe43d6d56)), closes [PR#3](https://github.com/PR/issues/3)
* **procurement-workspace:** slice 3a — PO zone แก้ผู้ค้า (vendor FK dropdown) ([6175864](https://github.com/aegisx-platform/aegisx-starter/commit/61758648696f30fb49f55e0b15bb36e7cb6b5755))
* **procurement-workspace:** slice 3b — คอลัมน์ PO อ่านอย่างเดียวในตารางกลาง (dual) ([a7f6d67](https://github.com/aegisx-platform/aegisx-starter/commit/a7f6d671eaf4afe71bdf8b778554318fefaa8f12))
* **procurement-workspace:** slice 4 — PO zone inline edit + save + selector ([c4404ff](https://github.com/aegisx-platform/aegisx-starter/commit/c4404ffefdee6f6d13e1bc85477431224b63bf4d))
* **procurement-workspace:** slice 5 — action in-place (เพิ่ม PO 1:N) ปิด plan ([ff7c55c](https://github.com/aegisx-platform/aegisx-starter/commit/ff7c55c62c5860387bc08fb26755a06c86b3a8da))
* **procurement-workspace:** slice 5 — ถอด dialog-hop 'แก้ไข' → ปลดล็อก inline (ปิด plan) ([3a1d7b8](https://github.com/aegisx-platform/aegisx-starter/commit/3a1d7b8172fe3dac3ddc53a6973804c0276137c4)), closes [PR#3](https://github.com/PR/issues/3) [PR#3](https://github.com/PR/issues/3)
* **procurement:** audit log ทุกการแก้รายการ PR (persist จริง) ([09a5948](https://github.com/aegisx-platform/aegisx-starter/commit/09a59487c7266abbc82e43900c6b81d89698ef69))
* **procurement:** tracker page with 2-zone row actions + route + menu ([3e266f0](https://github.com/aegisx-platform/aegisx-starter/commit/3e266f0dc2a35291083966584d3ce6897598f871))
* **procurement:** ล็อกแก้รายการ PR ตอน PO ส่งผู้ค้า + cascade PR→PO atomic ([41ab0aa](https://github.com/aegisx-platform/aegisx-starter/commit/41ab0aa3b8d6e36f0d4e65f837a810cf48efd551))
* **tracker:** badge มีสัญญาแสดงเลขที่สัญญาของ รพ. ในวงเล็บ ([222bf87](https://github.com/aegisx-platform/aegisx-starter/commit/222bf87ca384a44e3e028658196d9024f7efe772))
* **tracker:** data-access service wrapping existing endpoints ([592f6d6](https://github.com/aegisx-platform/aegisx-starter/commit/592f6d64c8c27ff85229c37087950e58dd6e5470))
* **tracker:** deriveMilestone util + types ([269acf1](https://github.com/aegisx-platform/aegisx-starter/commit/269acf1f79f372b3faa5ddac56d43206389f37db))
* **tracker:** list แสดงชื่อยา (trade) + บรรทัด generic เต็ม (field first_item_trade_name) ([5c83180](https://github.com/aegisx-platform/aegisx-starter/commit/5c8318091d95ffc8e39538dd446fd2f84670e530))
* **tracker:** pr zone แก้ inline ครบใบ — เหตุผล + งบ/หน่วยงาน/ปีงบ (slice 1a+1b) ([897a8ac](https://github.com/aegisx-platform/aegisx-starter/commit/897a8acd93a948f4bd5dcc796751f5e79b98329d))
* **tracker:** stepper ขั้นที่ผ่านแล้วเป็นเครื่องหมายถูก ✓ (แยกจากขั้นปัจจุบัน) ([17f8c5f](https://github.com/aegisx-platform/aegisx-starter/commit/17f8c5fc321802d2b5091b54ac86ceda89611802)), closes [#fff](https://github.com/aegisx-platform/aegisx-starter/issues/fff)
* **tracker:** title ใช้ชื่อยาจาก drug + ต่อหน่วยฐานท้าย generic line แบบ list ([ac3bc91](https://github.com/aegisx-platform/aegisx-starter/commit/ac3bc913c6cc8b17db57167fddafb81d6038d0f1))
* **tracker:** tracker badge dumb component ([60f570a](https://github.com/aegisx-platform/aegisx-starter/commit/60f570a9017b5f7cd5da3855ff73a5ce4b724965))
* **tracker:** ใช้ปุ่มพิมพ์ตัวเต็มใน detail dialog + ขยาย dialog เป็น 980px ([9621138](https://github.com/aegisx-platform/aegisx-starter/commit/962113829d17fca3bf98ede1927bb8fccc6462c4))
* **tracker:** ตั้ง tracker เป็นเมนูจัดซื้อหลัก แทน "ใบขอซื้อ" ([50ceb1a](https://github.com/aegisx-platform/aegisx-starter/commit/50ceb1ac6c11817da2791bb37ae6865bf8fabc4f))
* **tracker:** บรรทัดล่างเป็นชื่อ generic เต็ม (นำด้วยชื่อสามัญ) + ขยาย dialog เป็น 1120px ([f379682](https://github.com/aegisx-platform/aegisx-starter/commit/f379682d0df5c9abd725d531b6379ffa06cc2265))
* **tracker:** ย้ายสถานะสัญญาเข้าคอลัมน์แรก + เพิ่ม filter มีสัญญา/ไม่มีสัญญา ([0ab297d](https://github.com/aegisx-platform/aegisx-starter/commit/0ab297dd11a954a181cf67d539d89624083453e9))
* **tracker:** ย้ายสถานะสัญญาไปไว้ใต้ชื่อผู้ค้าแทนคอลัมน์แรก ([b32a48d](https://github.com/aegisx-platform/aegisx-starter/commit/b32a48df8f80e8d4ed17ad8d0fd22f7cc07f568a))
* **tracker:** ห้อยชื่อ generic แบบเต็มมาตรฐานใต้ชื่อยาใน detail dialog ([0920e82](https://github.com/aegisx-platform/aegisx-starter/commit/0920e824549921952655a97c818a48ee5e259ab8))
* **workspace:** แก้ราคา PO line inline ในหน้า tracker (ตกลง แก้ได้เมื่อ PO ร่าง/pending) ([f2e533e](https://github.com/aegisx-platform/aegisx-starter/commit/f2e533e031426a25de5f08863b5d67038d2bce4a))
* **workspace:** เปิด detail dialog เต็มจอ (fullscreen) ([244af9a](https://github.com/aegisx-platform/aegisx-starter/commit/244af9a2fc225823e0d17f54842c1bf4222e6e82))
* **workspace:** ย้ายแก้ยาเข้า tab PR/PO + ปุ่มแก้ข้อมูลจัดซื้อเต็ม (reuse ฟอร์ม PR) ([24262b4](https://github.com/aegisx-platform/aegisx-starter/commit/24262b4e643aeb6000ee417fb24d6eef03341712))
* **workspace:** แยกข้อมูล PR / PO เป็น tab ใน detail dialog ([cfe91b4](https://github.com/aegisx-platform/aegisx-starter/commit/cfe91b41f30a7ae355501872f069b0aa213e1a70))
* **workspace:** รวม PR/PO เป็นเอกสารเดียว read-first + จัด layout grid ([21efa51](https://github.com/aegisx-platform/aegisx-starter/commit/21efa51d75715986c6c4eddcbf3707e13f70e344))
...
* **api,web:** block PR cancel/revert while a live PO exists ([2b32ee6](https://github.com/aegisx-platform/aegisx-starter/commit/2b32ee6fe5657e8dbae9d375217de027eb85cbe3))
* **api:** 3 latent bugs surfaced by typecheck (this-binding + wrong props) ([c671580](https://github.com/aegisx-platform/aegisx-starter/commit/c6715804da3c98ee3c2de924e0cb60f15ac74b10))
* **api:** add 3 drifted unit columns to vendor-selections entity (type-only) ([8d37c54](https://github.com/aegisx-platform/aegisx-starter/commit/8d37c54c548a2e177d83624abeecfa5a4f47b60d))
* **api:** add 4 drifted columns to BudgetRequestItemsEntity (type-only) ([86fef5d](https://github.com/aegisx-platform/aegisx-starter/commit/86fef5dbff4bad7d114f8979bd3309b1e39cf77b))
* **api:** align PR entity with its columns + type transformToDb auto-filled fields ([f1b1c73](https://github.com/aegisx-platform/aegisx-starter/commit/f1b1c7330bdeec72399ffa9dba00b7b765ca4a21))
* **api:** align tsconfig lib/target with Node 22, exclude tsx-only scripts from typecheck ([483aeed](https://github.com/aegisx-platform/aegisx-starter/commit/483aeed8d72967925eb65b42a1ff726db1497ed6))
* **api:** coerce dropdown option labels to string (5 services, type-only) ([82dacef](https://github.com/aegisx-platform/aegisx-starter/commit/82dacefd279111c93070ab61ffeb7ed40743466d))
* **api:** coerce drug id to number for findSubstitutes call (type-only) ([b4baad5](https://github.com/aegisx-platform/aegisx-starter/commit/b4baad5e516e423c70611b81ac7148266a3be75b))
* **api:** constrain migration columnMapping transform/lookupBy to their enums ([ba43604](https://github.com/aegisx-platform/aegisx-starter/commit/ba4360422342026989574f10300736d400cea7e4))
* **api:** correct receipt dropdown field reads + drop dead delete placeholder ([4d6ea4c](https://github.com/aegisx-platform/aegisx-starter/commit/4d6ea4c496b350824d82dc1e5e7189bdc228e14b))
* **api:** drop dead workflow-field copies from disposal transformToDb (type-only) ([0dd3614](https://github.com/aegisx-platform/aegisx-starter/commit/0dd36149dc079df77e692533e10af528d5939d6c))
* **api:** drop stale generic_id/drug_id reads in drug-focus-lists transforms ([b9bcf4d](https://github.com/aegisx-platform/aegisx-starter/commit/b9bcf4d5119e85f08758755ac91d9bf9e7879354))
* **api:** expose budgetReservationsService for controller reservation handlers (type-only) ([8a511bd](https://github.com/aegisx-platform/aegisx-starter/commit/8a511bd09fc341bbf008d640dda2812a64a7d403))
* **api:** implement missing ContractsRepository.markExpiredBatch ([7f26ab6](https://github.com/aegisx-platform/aegisx-starter/commit/7f26ab64f5a4bf05f9be4ffdc2d9a83da373952e))
* **api:** master-data resolver insert() returns id string in update branch ([3bc9ebf](https://github.com/aegisx-platform/aegisx-starter/commit/3bc9ebfdab3b69bf4854a8f9b360b0a2e9ef40c7))
* **api:** pass authenticated userId to PR cancel + create-PO (arg misalignment) ([d8c4353](https://github.com/aegisx-platform/aegisx-starter/commit/d8c4353aefcc89d58037a9b9b426dcd6ff7121d0))
* **api:** pass item_adjustments (not comment) to PR approve (feature-breaking bug) ([a721b67](https://github.com/aegisx-platform/aegisx-starter/commit/a721b67f9eca714bbff41fd2586faeb0b7aa11de))
* **api:** pass missing ExportService to 5 controllers (DI arg mismatch) ([859a8a9](https://github.com/aegisx-platform/aegisx-starter/commit/859a8a92540d11e9710bb0c135ff22e8c500c486)), closes [#341](https://github.com/aegisx-platform/aegisx-starter/issues/341)
* **api:** pass object params to unit conversion (positional args crashed) ([e97f459](https://github.com/aegisx-platform/aegisx-starter/commit/e97f459f81a58706fc7c37ecb098f15d62c2c250))
* **api:** quick-search ราคากลาง missing dosage form/strength on cards ([99aaf00](https://github.com/aegisx-platform/aegisx-starter/commit/99aaf008ae9ca8cedbc9b03fc62edc6cad433243))
* **api:** read Permission.resource (not resource_name) in rbac.service (real bug) ([cc3475f](https://github.com/aegisx-platform/aegisx-starter/commit/cc3475f02afa2b7b68aa499af93ce1b2f4d4a02e)), closes [#348](https://github.com/aegisx-platform/aegisx-starter/issues/348)
* **api:** record real resource name in RBAC permission audit logs (real bug) ([9cd8e61](https://github.com/aegisx-platform/aegisx-starter/commit/9cd8e61c869a18fe30f349ad8f853721f78c6c0b))
* **api:** reject vendor-less PR in create-po and write CONVERTED status ([a9cd0cc](https://github.com/aegisx-platform/aegisx-starter/commit/a9cd0cc9baee49bb1c86a9b0677d5f1d8b5d1410))
* **api:** remove dead generic_id from po-items transforms (type-only) ([e16908d](https://github.com/aegisx-platform/aegisx-starter/commit/e16908d53b96a8fc5c8c2c255473a8b7b8fa7ce5))
* **api:** repair broken import paths, missing exports, ambiguous re-exports ([2f451c1](https://github.com/aegisx-platform/aegisx-starter/commit/2f451c1224c389598af3f6924f6868285e56806e))
* **api:** repair drug-lots & hospitals Excel import date transform ([66aab33](https://github.com/aegisx-platform/aegisx-starter/commit/66aab33290bbe33bc36a40ac37799f57f9e41433))
* **api:** resolve 14 typecheck errors across inventory + platform ([e3584a6](https://github.com/aegisx-platform/aegisx-starter/commit/e3584a6512d48ad7cc16ecbfa5a8cf91305daf29))
* **api:** resolve 22 typecheck errors — base repo contract + rbac audit + import cleanups ([0ece822](https://github.com/aegisx-platform/aegisx-starter/commit/0ece82290c1623d8241b410e024b6b1805064e20))
* **api:** resolve final 7 typecheck errors → api:typecheck at zero ([65b3fd4](https://github.com/aegisx-platform/aegisx-starter/commit/65b3fd448642b2d50d1741a7c6440aae3c6db17c))
* **api:** type count-query rows in setup status service (type-only) ([a7bd69b](https://github.com/aegisx-platform/aegisx-starter/commit/a7bd69b1173b0755131c01f5d991fcde06ec7213))
* **api:** type department tree nodeMap key as number (type-only) ([b7d7c75](https://github.com/aegisx-platform/aegisx-starter/commit/b7d7c7589148a2ccc0fd16bcdc9adc63ce2a509c))
* **api:** type drug-distribution transform params for workflow fields (type-only) ([04d6ffd](https://github.com/aegisx-platform/aegisx-starter/commit/04d6ffdde22309d793cf7f2f7cebc9d0cf4ebb7c))
* **api:** type job logger as Pick<FastifyBaseLogger> in delivery-alert ([54d0259](https://github.com/aegisx-platform/aegisx-starter/commit/54d025990f270461ea30a448303e80f2853f9ade))
* **api:** type knex .select([...]) rows as Record<string, any>[] (type-only) ([03a2fe6](https://github.com/aegisx-platform/aegisx-starter/commit/03a2fe60010833c812c6b8bfc3641a6093964ae4))
* **api:** type knex aggregate results in procurement-dashboard repository ([fe0fba3](https://github.com/aegisx-platform/aegisx-starter/commit/fe0fba38eef0c10081f40709b69061a02f0dec41))
* **api:** type migration transformBatchRecord param as BatchRecord (type-only) ([c3c8e51](https://github.com/aegisx-platform/aegisx-starter/commit/c3c8e5156576062cc6a9d4a242ee1a349ee6c063))
* **api:** type pdfmake table rows in document-transmittal-pdf service ([082bab0](https://github.com/aegisx-platform/aegisx-starter/commit/082bab04ee78d8847435de48a439daf2afe76946))
* **api:** type PR transform params for intentionally-excluded fields (type-only) ([0db2bf8](https://github.com/aegisx-platform/aegisx-starter/commit/0db2bf8c1c41362506edc3301a44c7b83651865d))
* **api:** type pr-item map + fix undefined contract var in util alert ([c9c826c](https://github.com/aegisx-platform/aegisx-starter/commit/c9c826c5f51bd875e186d4cd5f3f165d0d9e6926))
* **api:** type remaining knex aggregate .first() results (Pattern A) ([468157b](https://github.com/aegisx-platform/aegisx-starter/commit/468157b08ad3d1c9c095c45c02324d148c84588f))
* **api:** use ISO string for stock-count timestamps (type-only) ([8040701](https://github.com/aegisx-platform/aegisx-starter/commit/804070112d77e36f6f4aa02737a26b18e8005e24))
* **api:** use real .knex accessor in stock methods (getDb() never existed) ([3bdd603](https://github.com/aegisx-platform/aegisx-starter/commit/3bdd60365a5f54d0c7245258cadebf311bc7338f))
* **api:** widen drug-distributions transformToDb param for workflow fields (type-only) ([55a1879](https://github.com/aegisx-platform/aegisx-starter/commit/55a1879bf8b94bdb884a3ef853749630d7662ac3)), closes [#350](https://github.com/aegisx-platform/aegisx-starter/issues/350)
* **audit:** login-attempts stats bind API fields จริง (total/successCount/failureCount) ([bcce600](https://github.com/aegisx-platform/aegisx-starter/commit/bcce600a5bca24f4b43a1eda54eb534781abe287))
* **backup:** ax-badge ใช้ color แทน variant สำหรับสี semantic ([48abced](https://github.com/aegisx-platform/aegisx-starter/commit/48abcedfb45a8b79a6dc282218bebf2fcdc85d29))
* **backup:** hasLocalBreadcrumb เพื่อไม่ให้ shell breadcrumb ซ้อนกับ ax-page-shell ([cdcb1ca](https://github.com/aegisx-platform/aegisx-starter/commit/cdcb1cadf3b600ba504da2b71389daa409ec0537))
* **backup:** replace custom divs with ax-card per UI component standard ([36c8b32](https://github.com/aegisx-platform/aegisx-starter/commit/36c8b32af5f57bc73af222a5196a00a994c94e59))
* **backup:** use type= not variant= on ax-badge (BadgeVariant ≠ BadgeType) ([5d8b332](https://github.com/aegisx-platform/aegisx-starter/commit/5d8b332a0bce6ade9af207d32db03bcca26a8f34))
* **backup:** use variant= not appearance= on ax-card (correct @Input name) ([a881751](https://github.com/aegisx-platform/aegisx-starter/commit/a8817518a0cb7538fb39e787efa9b6762313b263))
* **backup:** แก้ 5 ปัญหาจาก code review รอบที่ 2 ([6d19d90](https://github.com/aegisx-platform/aegisx-starter/commit/6d19d90ec29d9d494dfa5bb4a8d25efea2c6689d))
* **backup:** แก้ URL double-prefix + ใช้ ax-page-header ใน header slot ([db7bbbd](https://github.com/aegisx-platform/aegisx-starter/commit/db7bbbd825ce05e3a1393e2a17685c5c0757f77d))
* **backup:** ย้าย action button เข้า ax-page-header ตาม standard layout ([f61319a](https://github.com/aegisx-platform/aegisx-starter/commit/f61319a417d92015b052a2bc22684f938c129f6e))
* **backup:** ส่ง breadcrumb ให้ ax-page-shell ตาม layout standard (เหมือน PO/PR) ([44ba99d](https://github.com/aegisx-platform/aegisx-starter/commit/44ba99d850b3f4cfcda312471bd24caa59aaa9f7))
* **dispensing:** correct stale reason JSDoc + drop unused CommonModule ([2cdff6e](https://github.com/aegisx-platform/aegisx-starter/commit/2cdff6e455546a99889c5b95a2178a87ebecea10)), closes [#339](https://github.com/aegisx-platform/aegisx-starter/issues/339)
* **dispensing:** HIS FIFO lots path — shortfall log + double-deduction guard ([79f4f9f](https://github.com/aegisx-platform/aegisx-starter/commit/79f4f9fa3e612a1af6d01a0bbb126ada8601805c))
* **dispensing:** HIS sync deduction — zero-qty promote + stranded-item retry ([1f37061](https://github.com/aegisx-platform/aegisx-starter/commit/1f37061c58092363f39bc6817a258ee99c58947a)), closes [#2](https://github.com/aegisx-platform/aegisx-starter/issues/2) [#1](https://github.com/aegisx-platform/aegisx-starter/issues/1)
* **dispensing:** persist his_unit + resolve unit_id on retry ([#5](https://github.com/aegisx-platform/aegisx-starter/issues/5)); fix migration collision ([e997970](https://github.com/aegisx-platform/aegisx-starter/commit/e997970e4dba052341aa34824eaa1717c7cd1977))
* **dispensing:** unfulfilled-summary reason must reflect CURRENT stock ([3d4f371](https://github.com/aegisx-platform/aegisx-starter/commit/3d4f3715494fe14b7a0b5859c73006a461170d25)), closes [#340](https://github.com/aegisx-platform/aegisx-starter/issues/340)
* **inventory:** align PR government-report PDF header with real .docx ([bc5d370](https://github.com/aegisx-platform/aegisx-starter/commit/bc5d3707475715271ea1b13f9b918de583d63a98))
* **inventory:** restore released migration name for drop_drug_generics_base_unit ([11a4106](https://github.com/aegisx-platform/aegisx-starter/commit/11a4106de8a53cd935cb2e98374cc06a9122de92))
* **inventory:** show '-' placeholder for empty รูปแบบ/ขนาดบรรจุ cells in drug-price list ([535fee9](https://github.com/aegisx-platform/aegisx-starter/commit/535fee90d5bbebe4ee05f50318382fd2d86fe96f))
* **inventory:** ให้ S6 inherit ทำงานบน import flow จริง (executeImport) ([f41fb94](https://github.com/aegisx-platform/aegisx-starter/commit/f41fb940c014b72b61afebeea18ee6da9a69c40d)), closes [#380](https://github.com/aegisx-platform/aegisx-starter/issues/380)
* **pdf:** center บันทึกข้อความ title and วันที่ start in PR/PO memos ([48b0806](https://github.com/aegisx-platform/aegisx-starter/commit/48b08066abb25ddd87a2878746c700457727d2c3))
* **po:** แก้ตาม fable review — signer divergence + e-GP length funnel ([466a669](https://github.com/aegisx-platform/aegisx-starter/commit/466a669046ae72fd8bc2cd8a9b78d33bafdb9bfb))
* **po:** ชื่อยาในใบรายงานผลการพิจารณา/ตาราง PO แสดงเต็มเหมือน PR ([66f9d94](https://github.com/aegisx-platform/aegisx-starter/commit/66f9d94c0708a2b8cbc992e6e77e1b2331719158))
* **po:** เอาพื้นหลังสีชมพู e-GP ออกจากใบสั่งซื้อสัญญา ([357b1b8](https://github.com/aegisx-platform/aegisx-starter/commit/357b1b8690ce046e731d48eb7eeb6a5e13f056b7))
* **procurement:** resolve PO contract_id so contract POs print ไม่จำกัดปริมาณ ([5e61730](https://github.com/aegisx-platform/aegisx-starter/commit/5e617307da278b049d790e5a57e18b3ce469d54a))
* **procurement:** คืน reference_price_unit/source จริงจากใบล่าสุดใน last-purchase-price (S3 gap) ([3fc04a9](https://github.com/aegisx-platform/aegisx-starter/commit/3fc04a9b160dcd8cb7de078728597a4354e5e0ba))
* **procurement:** ปรับฟอร์มปริ้น PO สัญญา + รายงานผลการพิจารณา ให้ตรงมาตรฐาน ([bf18090](https://github.com/aegisx-platform/aegisx-starter/commit/bf180907bfcfe74334e4d24a922a49bf34bc0212))
* **pr:** เบอร์โทรกลุ่มงานใส่เฉพาะบรรทัด ส่วนราชการ (หัวกระดาษ) ([270c602](https://github.com/aegisx-platform/aegisx-starter/commit/270c6024b52c00ebbef304760cb8fb39ffc7b929))
* **purchase-orders:** payment_terms ว่าง → null กัน 22P02 ตอนสร้าง PO ([e670dda](https://github.com/aegisx-platform/aegisx-starter/commit/e670ddacaede832225220bf20104912a4246845a))
* **purchase-orders:** ประเภท/วิธีการจัดซื้อ ตอนสร้าง PO — รับ null + ไม่ถูก drop ([b2488e0](https://github.com/aegisx-platform/aegisx-starter/commit/b2488e099e60e057f97b5053223712eda8916faa))
* **purchase-orders:** เอา option NET90 ออก — ไม่มีใน enum payment_terms ([6805e14](https://github.com/aegisx-platform/aegisx-starter/commit/6805e14143f042b59a50085e24c623b07f228e02))
* **purchase-requests:** use reply helpers for stock-info/purchase-history errors ([dad24dd](https://github.com/aegisx-platform/aegisx-starter/commit/dad24ddd698946008eb731f4f42651defec74de2))
* **system:** breadcrumb label ถูก context — departments/users/master-data ([51f3d59](https://github.com/aegisx-platform/aegisx-starter/commit/51f3d59e1f6665f06983a94fddc43711624b5792))
* **system:** hasLocalBreadcrumb กัน breadcrumb ซ้อน monitoring/dashboard + audit 2 หน้า ([7cd0150](https://github.com/aegisx-platform/aegisx-starter/commit/7cd015036f8199cedf72beb1cc8a8ec2307a4ba7))
* **system:** hasLocalBreadcrumb กัน breadcrumb ซ้อนบนหน้า departments + file-upload ([812c4b1](https://github.com/aegisx-platform/aegisx-starter/commit/812c4b1c057d40da33edae441bc10bc325bcf2ef))
* **web:** sync reference/last-purchase price to form on every keystroke ([f854a43](https://github.com/aegisx-platform/aegisx-starter/commit/f854a439d825f717d1ffbe744d8b3484e27ec01a))


### Features

* **dispensing:** report why retry-draft leaves items unfulfilled ([eea9ab1](https://github.com/aegisx-platform/aegisx-starter/commit/eea9ab15441f2350ff6c92737b8d4d73fcafb3c0))
* **dispensing:** show WHY each item can't deduct + the action, at dispensing-sync ([cb012f3](https://github.com/aegisx-platform/aegisx-starter/commit/cb012f33d27ee58408eb08d49d96011bc1569f14))
* **inventory:** import ราคากลาง inherit การจับคู่จากสมุดอัตโนมัติ (S6) ([0730fd4](https://github.com/aegisx-platform/aegisx-starter/commit/0730fd4ac528e8fc35ac52658fa613441508bebd))
* **inventory:** real price-source name in quick-search header + aligned filter card ([53adb70](https://github.com/aegisx-platform/aegisx-starter/commit/53adb702b97d7cffea214f003b4ca1a2055a12a2))
* **inventory:** เตือนเมื่อราคาซื้อ PO เกินราคากลาง (badge อย่างเดียว ไม่บล็อก) ([50079fb](https://github.com/aegisx-platform/aegisx-starter/commit/50079fb0c85845a52c8811f6514fd0a1b8e86505))
* **po:** /from-pr inherit document_number + purchase_method_id จาก PR (Slice B) ([f01bc88](https://github.com/aegisx-platform/aegisx-starter/commit/f01bc88e0cbd8dda651140af42ced86768ce6f6e))
* **po:** auto-fill PO header จาก PR ที่เลือก (Slice A) ([032af71](https://github.com/aegisx-platform/aegisx-starter/commit/032af71e8a50670b356f1bcbb97eb513ff636172))
* **po:** wire e-GP PR→PO + wizard section (Slice D) ([ac3e285](https://github.com/aegisx-platform/aegisx-starter/commit/ac3e285fb228dbe5d333f744b488d97b0eb4ae70))
* **po:** เพิ่มเหตุผลสั่งซื้อ "เพื่อใช้ในการรักษาพยาบาล" (code 11) ([a7b642a](https://github.com/aegisx-platform/aegisx-starter/commit/a7b642ada82efba0f9bac4e279b60162858d90ca))
* **po:** เลขที่โครงการ/เลขคุมสัญญา ท้ายใบสั่งซื้อปกติ คนละบรรทัด ([cdf8170](https://github.com/aegisx-platform/aegisx-starter/commit/cdf81708a301edbd6f88afa1a7fa39836f438250))
* **procurement:** persist หน่วย+แหล่งที่มาราคากลาง ลงใบ PR/PO + สมุดจับคู่ hash_norm (S3) ([997a99c](https://github.com/aegisx-platform/aegisx-starter/commit/997a99ca8052ab36b3db564b8ffced140b9d70c5))
* **procurement:** pre-fill ราคากลางจากใบล่าสุด/master ใน drug selector (S1) ([914bdd5](https://github.com/aegisx-platform/aegisx-starter/commit/914bdd545f7135a67109a5a1f84b23e174196d4a))
* **procurement:** write-back ราคากลางกลับ master ตอน save PR (S2) ([439445a](https://github.com/aegisx-platform/aegisx-starter/commit/439445a5410abb2a77cfe4499d2b8685c7d6086a))
* **procurement:** แก้ราคากลาง PO ต่อรายการ + write-back master (S5a) ([3431091](https://github.com/aegisx-platform/aegisx-starter/commit/343109126552ded1d25278358f30d75ad52030d7))
* **procurement:** จับคู่ราคากลางจาก pool ประกาศ + จำลงสมุด (S4) ([6aa820d](https://github.com/aegisx-platform/aegisx-starter/commit/6aa820d078e0497ae3c1d28a9d8e3332937e3470))
* **procurement:** รวม po_items ในการหา "ใบล่าสุด" ของราคากลาง (S5d) ([30485a9](https://github.com/aegisx-platform/aegisx-starter/commit/30485a985424f5a6ed0a839f1d0015e0993d711d))
* **procurement:** หน้า PO detail แก้ราคากลางต่อรายการได้ (S5c) ([c91abe8](https://github.com/aegisx-platform/aegisx-starter/commit/c91abe8cb805829355e31a55f0fc15e2f8afbee6))
* **pr:** เพิ่ม e-GP project_number + control_number ที่ PR (Slice C) ([44ff44b](https://github.com/aegisx-platform/aegisx-starter/commit/44ff44b23af644a0288db0362aa0412251e285b6))
* **purchase-orders:** กำหนดส่งมอบเป็น dropdown+auto-คำนวณวันที่ + จัด layout 3 คอลัมน์ ([51b797a](https://github.com/aegisx-platform/aegisx-starter/commit/51b797a6248c22ea7f55c660493f74642a2b5e1e))
* **rbac-audit:** persist client user_agent for forensics ([b115d87](https://github.com/aegisx-platform/aegisx-starter/commit/b115d87e66ad9c99e9870a3f47dabbf97c3b6631))
* **settings:** เพิ่ม field เบอร์โทรกลุ่มงาน (department_group_phone) ([4975ac9](https://github.com/aegisx-platform/aegisx-starter/commit/4975ac9f40233fa82a53c49d90b2c0c6761acd59))
* **web:** redesign drug-price quick-search as separable per-generic cards ([7168f90](https://github.com/aegisx-platform/aegisx-starter/commit/7168f90018bd6c2f0c02edbb058c8da6b4947053))
* **web:** sticky search + auto-load + trim sort on drug-price quick-search ([432dc2f](https://github.com/aegisx-platform/aegisx-starter/commit/432dc2f7e519561a2048ebfacc674359506e5595))


### Performance Improvements

* **dispensing:** read-only aggregate endpoint for unfulfilled breakdown ([67d6d6f](https://github.com/aegisx-platform/aegisx-starter/commit/67d6d6ff437640c05f89f51e4e707a124f1fd923)), closes [#339](https://github.com/aegisx-platform/aegisx-starter/issues/339)
...
* **advance-dispatch:** ใช้ large_unit (หน่วยใหญ่) แทน base_unit ในการเบิกล่วงหน้า ([c6b2baf](https://github.com/aegisx-platform/aegisx-starter/commit/c6b2baf4942ba373a6e02e8025710d0931ccaf46))
* **document-dispatch-slips:** center PDF header title ([34e80c8](https://github.com/aegisx-platform/aegisx-starter/commit/34e80c815b6f5a3add223725e3365a4abf9b4934))
* **document-dispatch-slips:** compact PDF header layout ([21bca83](https://github.com/aegisx-platform/aegisx-starter/commit/21bca833e3b005fa71eda6e3e35378da94244636))
* **document-dispatch-slips:** fix 3 bugs found during API testing ([e8c8bc1](https://github.com/aegisx-platform/aegisx-starter/commit/e8c8bc1bacdb3d5892bd9691604ea6cc9816b8ee))
* **document-dispatch-slips:** fix Angular compile errors in all 5 pages ([6465ec1](https://github.com/aegisx-platform/aegisx-starter/commit/6465ec175f29c6f248c9d041f29520686ef98d01))
* **document-dispatch-slips:** move QR to top-right corner, reduce size to 56px ([671985d](https://github.com/aegisx-platform/aegisx-starter/commit/671985d31b5fa0af4e045add5d3421c791b21e86))
* **document-dispatch-slips:** ใช้ ax-page-shell [breadcrumb] + div header pattern ตาม standard ([e891932](https://github.com/aegisx-platform/aegisx-starter/commit/e8919326de5da50b756983e00ce123e6fe3bc036))
* **drug-reference-prices:** center search container ด้วย margin auto ([54b25f9](https://github.com/aegisx-platform/aegisx-starter/commit/54b25f96e6e3f0c42b0b10c846ae950bdec49943))
* **drug-reference-prices:** reset mat-card margin ให้ cards เต็มความกว้าง container ([8fb9a81](https://github.com/aegisx-platform/aegisx-starter/commit/8fb9a811ed679c98e2e720a2233c53d1107570e0))
* **drug-reference-prices:** กรองรายการตาม source_id จาก URL query param ([80055d9](https://github.com/aegisx-platform/aegisx-starter/commit/80055d95c78bcc598eca7bcf499fc9b4dc3802bd))
* **drug-reference-prices:** แก้ flex layout ใน mat-card + จำกัด content width 900px ([236a976](https://github.com/aegisx-platform/aegisx-starter/commit/236a9767a6fad3fabc9b09e45a9272dd97d53de5))
* **drug-reference-prices:** แก้ quick-search filter ไม่ทำงาน + layout ราคาซ้อน ([b3718bd](https://github.com/aegisx-platform/aegisx-starter/commit/b3718bd63d7da6e1d5dcf89bf8300710a23c1c8e))
* **drug-reference-prices:** ใช้ --ax-* token แทน hardcoded hex ใน quick-search ([e8a78ab](https://github.com/aegisx-platform/aegisx-starter/commit/e8a78ab7131ea9f103806cd01fba86bf65a539f3))
* **drug-reference-prices:** ปรับ quick-search UI ตาม AegisX design system ([0092160](https://github.com/aegisx-platform/aegisx-starter/commit/0092160edc1803a8dd5b706e6764ba341a2a34e6)), closes [#6366f1](https://github.com/aegisx-platform/aegisx-starter/issues/6366f1)
* **drug-reference-prices:** รวม wrapper เดียว ให้ search+cards ตรงกัน + คืน padding card ([471b7fc](https://github.com/aegisx-platform/aegisx-starter/commit/471b7fc315526ba85199fc9f0318c10818676a9d))
* **drugs:** clear dirty state after save so no false unsaved-changes prompt ([544bfe1](https://github.com/aegisx-platform/aegisx-starter/commit/544bfe1add665b7cf463c050881cf080a8796be0))
* **import-wizard:** replace hardcoded hex colors with --ax-* tokens ([60daa2f](https://github.com/aegisx-platform/aegisx-starter/commit/60daa2f619ee4e1c998498ecf03a86b2e96e55a1))
* **import:** allow update-only imports in the wizard ([a222401](https://github.com/aegisx-platform/aegisx-starter/commit/a222401790353011ed7e5e0c99edc195f8ed7dff))
* **import:** resolve hospital drug group name to drug_group_id FK ([6d52c05](https://github.com/aegisx-platform/aegisx-starter/commit/6d52c0516e977bbb88da72cbae714d23041a2f21))
* **import:** resolve pharmacological group name to pharmacological_group_id FK ([48ce44b](https://github.com/aegisx-platform/aegisx-starter/commit/48ce44bedd55e4518a48c32adcd6a4b9e70a65db))
* **procurement-register:** แก้ตาม PR review (cap export, OnPush dialog, ตัด sort/CommonModule) ([15d9f95](https://github.com/aegisx-platform/aegisx-starter/commit/15d9f953893d603c9aca887dd83e75a64f3a3917))
* **procurement-register:** แก้ตาม PR review รอบ 2 (PDF track, is_active, /export schema) ([4f6c5a0](https://github.com/aegisx-platform/aegisx-starter/commit/4f6c5a01b42e6d4108c62962639a937a2b07ae47))
* **procurement:** guard against stale PO fetch in PR list print menu ([90aef37](https://github.com/aegisx-platform/aegisx-starter/commit/90aef379b5a88bf913955b4b3b9910ceba51a7f2)), closes [#306](https://github.com/aegisx-platform/aegisx-starter/issues/306) [#1](https://github.com/aegisx-platform/aegisx-starter/issues/1)
* **purchase-order-pdf:** improve PDF formatting across all PO templates ([31a29ab](https://github.com/aegisx-platform/aegisx-starter/commit/31a29abed4b035e7d9867a9dbd19999e0bc0f149))
* **purchase-order-pdf:** reduce table cell padding to 1pt across all PDF forms ([52c1395](https://github.com/aegisx-platform/aegisx-starter/commit/52c13952529e033072acea46c82ab97eff5326c2))
* **quick-build:** error discoverability + empty-state guard (review [#295](https://github.com/aegisx-platform/aegisx-starter/issues/295) follow-up) ([70e695a](https://github.com/aegisx-platform/aegisx-starter/commit/70e695ac6d2caf83757e404bf72878f1476e5453))
* **quick-build:** แก้ตาม code review PR [#292](https://github.com/aegisx-platform/aegisx-starter/issues/292) (HIGH[#2](https://github.com/aegisx-platform/aegisx-starter/issues/2) + 2 MED + LOW) ([8abc4b1](https://github.com/aegisx-platform/aegisx-starter/commit/8abc4b1fbb3b890e7d4f3a9b830efde00f72f232)), closes [HIGH#1](https://github.com/HIGH/issues/1)
* **quick-build:** แก้ตาม code review PR [#294](https://github.com/aegisx-platform/aegisx-starter/issues/294) (spinner/as-any/txn atomicity) ([5a92227](https://github.com/aegisx-platform/aegisx-starter/commit/5a922273b78f4314b340ff3854dcceaf578f7a1b)), closes [#1](https://github.com/aegisx-platform/aegisx-starter/issues/1) [#2](https://github.com/aegisx-platform/aegisx-starter/issues/2) [#4](https://github.com/aegisx-platform/aegisx-starter/issues/4) [#3](https://github.com/aegisx-platform/aegisx-starter/issues/3)
* **quick-build:** แก้ตาม code review PR [#295](https://github.com/aegisx-platform/aegisx-starter/issues/295) (a11y + class semantic) ([c49aa98](https://github.com/aegisx-platform/aegisx-starter/commit/c49aa9860d98d4daca72942841bdf186666f9438)), closes [#1](https://github.com/aegisx-platform/aegisx-starter/issues/1) [#3](https://github.com/aegisx-platform/aegisx-starter/issues/3) [#2](https://github.com/aegisx-platform/aegisx-starter/issues/2)
* **quick-build:** แก้ตาม code review PR [#295](https://github.com/aegisx-platform/aegisx-starter/issues/295) รอบ 2 (readability + alignment) ([bbf6db5](https://github.com/aegisx-platform/aegisx-starter/commit/bbf6db5ef0d7368cb73c03f4287cf8cf36d47d5b))
* **receipts:** use defined surface token + guard failed load on edit page ([038c0c2](https://github.com/aegisx-platform/aegisx-starter/commit/038c0c2c263a912db8ec881013b0cd655e65dc65))
* **requisition-slip:** use canvas rect for checkbox to fix oversized rendering ([36e8bf1](https://github.com/aegisx-platform/aegisx-starter/commit/36e8bf175a305c36d82b22fa349991ec8e576aeb))
* **sub-warehouse:** address code review findings ([130a706](https://github.com/aegisx-platform/aegisx-starter/commit/130a7069e00b0dbe1c088a3cf6820237c2224e71))
* **sub-warehouse:** address second round review findings ([a2a469d](https://github.com/aegisx-platform/aegisx-starter/commit/a2a469da5f11d8f84b6202d3771f121fc8270517))


### Features

* **advance-dispatches:** ขยาย dialog + แสดงรายละเอียดยาจาก drug_generics ([45dbf9c](https://github.com/aegisx-platform/aegisx-starter/commit/45dbf9c7e41c7574a96ea798f85f4c542b1f6835))
* **advance-dispatch:** แสดง stock summary card ข้างช่องจำนวน ([179ab70](https://github.com/aegisx-platform/aegisx-starter/commit/179ab709173be36a42edcd4479a049d8a0412c66))
* **advance-dispatch:** แสดงหน่วยใน list + สลับสีแถว + fix unit ไม่บันทึก ([0c1d759](https://github.com/aegisx-platform/aegisx-starter/commit/0c1d759681fb62cdac9c8410960e48b83363438b))
* **document-dispatch-slips:** add PDF preview dialog (pdfmake + ngx-extended-pdf-viewer) ([98a992a](https://github.com/aegisx-platform/aegisx-starter/commit/98a992ab89515120a354a99d6e24033132b781f8))
* **document-dispatch-slips:** add permissions seed for document dispatch slips ([e9b4d61](https://github.com/aegisx-platform/aegisx-starter/commit/e9b4d614b85a5501140d196fd1a36ab6cd79ffa1))
* **document-dispatch-slips:** redesign UI — ax-card, mat-table, tokens, maxWidth ([4606995](https://github.com/aegisx-platform/aegisx-starter/commit/4606995cc45639dfbfdf4c9bd733d99b1c8fd7b9))
* **document-dispatch-slips:** ใบนำส่งเอกสาร — warehouse to procurement handover ([9add8c7](https://github.com/aegisx-platform/aegisx-starter/commit/9add8c70b42389f8db76196612696b69b779274a))
* **po-api:** procurement_track + manual_po_ref ใน PO response + filter ([1e3f75e](https://github.com/aegisx-platform/aegisx-starter/commit/1e3f75e7fee9f09d69624d27a02da2eeb76cdd8f))
* **po-list:** filter + badge เงื่อนไข (e-GP/GFMIS) + แสดง manual_po_ref ([8e67681](https://github.com/aegisx-platform/aegisx-starter/commit/8e676817e477d1d1cf482beb85752233c6cc2935))
* **procurement-register:** export PDF ไทย รายเล่ม (pdfmake/Sarabun, landscape) ([73924a7](https://github.com/aegisx-platform/aegisx-starter/commit/73924a7ab0ba808389bf512309b9e8cc18e2ddce))
* **procurement-register:** export ทะเบียนเป็น Excel 3 เล่ม (header ตรง format เดิม) ([763bcbc](https://github.com/aegisx-platform/aegisx-starter/commit/763bcbc2b7c56a4a5fa390869ec0226ef3fc2eab))
* **procurement-register:** filters (ปีงบ/ค้นหา/รวมร่าง) + stats badges ต่อเล่ม ([2aa1e03](https://github.com/aegisx-platform/aegisx-starter/commit/2aa1e03500ef4be24460a0d3bf0112de92ff26e9))
* **procurement-register:** frontend types + data service (list/stats/export) ([fb37827](https://github.com/aegisx-platform/aegisx-starter/commit/fb37827490d96424b7783464414ed99e3455bc0b))
* **procurement-register:** read-only repository (DISTINCT ON latest receipt + stats + fiscal-year) ([f8a54c5](https://github.com/aegisx-platform/aegisx-starter/commit/f8a54c5bc095537ec4e494525e83154c1ab4427c))
* **procurement-register:** service+controller+route+register, list+stats API (verified 3 tracks) ([e6e5f93](https://github.com/aegisx-platform/aegisx-starter/commit/e6e5f93ff7657711f6fa8ea64c2f28314b3feb38))
* **procurement-register:** types + TypeBox schemas (read-only register) ([91544c3](https://github.com/aegisx-platform/aegisx-starter/commit/91544c3dd95812e83e72b74d776427970155ac9b))
* **procurement-register:** ปุ่ม export Excel/PDF (เล่มนี้ + 3 เล่ม) ([fa9474e](https://github.com/aegisx-platform/aegisx-starter/commit/fa9474ee67b80704b1c71b601bdb272286103813))
* **procurement-register:** พรีวิว PDF ผ่าน dialog (ngx-extended-pdf-viewer) ([df60703](https://github.com/aegisx-platform/aegisx-starter/commit/df6070345ab439c3ac519199bb4cc96139c58fe6))
* **procurement-register:** เพิ่มมูลค่ารวม (sum) ต่อเล่มใน stats (count + amount) ([23d8ccf](https://github.com/aegisx-platform/aegisx-starter/commit/23d8ccfaec78e500908bc442f1cdb74e6b315ce9))
* **procurement-register:** หน้า 3 tab + ตาราง + route + เมนู (browser verified) ([e77166b](https://github.com/aegisx-platform/aegisx-starter/commit/e77166bc30fa441a6fc9cdd60c205ddc788de3e8))
* **procurement:** unify print-document menu across PO and PR screens ([fa7c327](https://github.com/aegisx-platform/aegisx-starter/commit/fa7c327623c4953b3005260497cdd21c128600da))
* **procurement:** รองรับ procurement_track ค่าที่ 3 NON_GFMIS (เงินบำรุง ไม่ผ่าน GFMIS) ([6bc3448](https://github.com/aegisx-platform/aegisx-starter/commit/6bc344813e2f16d2cae111758080b5515ca93c3e))
* **purchase-orders:** filter เงื่อนไข ครบ 3 ค่า + ย้ายเป็น quick filter + fix param ที่ถูก drop ([a2799d8](https://github.com/aegisx-platform/aegisx-starter/commit/a2799d85c03b5cd4712aa2eaed180b1710dc4475))
* **purchase-orders:** optional garuda toggle for winner/winner-duplicate PDFs ([d7071c1](https://github.com/aegisx-platform/aegisx-starter/commit/d7071c17bca4f060125af348abb0f29d33ec351f))
* **quick-build:** badge เงื่อนไข (GFMIS/ไม่ผ่าน/e-GP) + เลข PO อ้างอิง ต่อแถว จากที่วาง ([a1680c6](https://github.com/aegisx-platform/aegisx-starter/commit/a1680c6e0695cdab7d18338a6c5496d26c3f496e))
* **quick-build:** group PO ตาม vendor+track + effectiveTrack อ่านเงื่อนไขจากชีต ([3f439e3](https://github.com/aegisx-platform/aegisx-starter/commit/3f439e3d517ffde93480dd945bcd394bbba21bbb))
* **quick-build:** toggle มุมมอง preview ตามผู้ขาย ↔ รายการแบนราบ (Slice 4) ([1a276fa](https://github.com/aegisx-platform/aegisx-starter/commit/1a276fa7400197fbabaa226c85d9c6c97a710ee6)), closes [#proposalRow](https://github.com/aegisx-platform/aegisx-starter/issues/proposalRow)
* **quick-build:** vendor แก้ได้ทุกแถวใน grid + เคลียร์ contract linkage เมื่อเปลี่ยนเจ้า ([97e65f0](https://github.com/aegisx-platform/aegisx-starter/commit/97e65f0ee617a40bbb4e3a1f5e80d348958025c1))
* **quick-build:** เติมราคาหลังสุด/ราคากลาง/แถม จากที่วาง + ชื่อยี่ห้อบน generic ล่าง ([ac23e3e](https://github.com/aegisx-platform/aegisx-starter/commit/ac23e3e31fc5b7a43ee6c6a4c310d576b6f200ba))
* **quick-build:** เพิ่ม dropdown เงื่อนไข (e-GP/GFMIS) + เลข PO เอง ใน grid (ระดับ group) ([9f3cba1](https://github.com/aegisx-platform/aegisx-starter/commit/9f3cba116a9e0636918f863ea1e5869f50abcc1e))
* **quick-build:** เพิ่ม procurement_track (เงื่อนไข e-GP/GFMIS) + manual_po_ref บน PO ([8095cab](https://github.com/aegisx-platform/aegisx-starter/commit/8095cabf4bb7f39c0e00002e91840c0f492bb8ca))
* **quick-build:** เพิ่มคอลัมน์ของแถม (bonus) ใน grid → บันทึก purchase_order_items.bonus_quantity ([6c830f9](https://github.com/aegisx-platform/aegisx-starter/commit/6c830f99601d9ab82dd0dee366a2e70aa9904a39))
* **quick-build:** เพิ่มคอลัมน์ราคากลาง (price_per_unit) + แยกราคาหลังสุด/ราคากลางใน grid ([19cabe0](https://github.com/aegisx-platform/aegisx-starter/commit/19cabe0873a2bf51e4d7bc85fa104d25d74ac633))
* **quick-build:** เพิ่มวันที่เอกสาร PO (po_date) เลือกได้ในชุด commit → บันทึก purchase_orders.po_date ([18f6963](https://github.com/aegisx-platform/aegisx-starter/commit/18f6963b510d7fd9e5e1e13194691f5704a4e8b3))
* **quick-build:** รวม errors[] เข้ากริดเป็นแถวสถานะ ERROR (Slice 6) ([5ce37e7](https://github.com/aegisx-platform/aegisx-starter/commit/5ce37e7e5461ffcf78390613efb4b5e068537ee6)), closes [#errorRows](https://github.com/aegisx-platform/aegisx-starter/issues/errorRows)
* **quick-build:** ราคากลางแก้ไขได้ + บันทึกต่อแถว write-back drug_reference_prices (Slice 5) ([185ea27](https://github.com/aegisx-platform/aegisx-starter/commit/185ea276aea96db864f9ee3efd723da4b74d73cc))
* **quick-build:** วางรายการจาก Excel (paste) เข้า grid โดย reuse /preview ผ่าน CSV ([b524b76](https://github.com/aegisx-platform/aegisx-starter/commit/b524b763fb99da9f489f1d7de12d10d6bfe1e018))
* **rbac:** grant drug-reference-prices update ให้ role inventory-procurement ([a75390c](https://github.com/aegisx-platform/aegisx-starter/commit/a75390c8125c50e02603cc0d8bfe4060f61c38b0))
* **receipts:** add component-scoped ReceiptFormService (builders, loaders, load/persist) ([3b2ad83](https://github.com/aegisx-platform/aegisx-starter/commit/3b2ad83ecc99d8b289c098f2acd86a2f013707ff))
* **receipts:** add full-page receipt edit route (:id/edit) with tabs ([95dd25b](https://github.com/aegisx-platform/aegisx-starter/commit/95dd25babf8b02a3326a39d2042fdd488e54a618))
* **receipts:** add presentational ReceiptItemsEditorComponent (Section 3) ([ce1a62c](https://github.com/aegisx-platform/aegisx-starter/commit/ce1a62c8fa86518a874a681908afba51bfd111dd))
* **receipts:** extract pure buildReceiptPayload util + unit tests ([3fe376f](https://github.com/aegisx-platform/aegisx-starter/commit/3fe376f639c33cc7c7065064fdfda143d0f2a76f))
* **receipts:** route detail edit button to full-page edit (:id/edit) ([e089922](https://github.com/aegisx-platform/aegisx-starter/commit/e0899226016d7adc42952c78dfc96bc8c19fbf9d))
* **requisition-slip:** redesign PDF layout to match hospital example ([842e2f7](https://github.com/aegisx-platform/aegisx-starter/commit/842e2f7547eb970dfed429b76a49032b9ddd5594))
* **sub-warehouse:** add drug_group_id filter to drugs API and hospital_settings migration ([67445d2](https://github.com/aegisx-platform/aegisx-starter/commit/67445d2431f760b250f011fb8c5420e65fe83df2))
* **sub-warehouse:** add requisition-by-drug-group mode ([24f5e64](https://github.com/aegisx-platform/aegisx-starter/commit/24f5e64e0cc82ae7501fd2a9efe0c4c23e5f7182))
* **sub-warehouse:** move print button outside action menu in requisitions list ([f887a8e](https://github.com/aegisx-platform/aegisx-starter/commit/f887a8efa4914efacb252290b00bc20b874f8728))
...
* **budget-requests:** show user names and department name in view dialog ([60c4772](https://github.com/aegisx-platform/aegisx-starter/commit/60c4772900f2e0d3b4ad67fbc1db5582262119e1))
* **budget-requests:** ยา import ไม่ตกหมวด 'เวชภัณฑ์ไม่ใช่ยา' อีก + ลบหมวดซ้ำซ้อน ([ce2528e](https://github.com/aegisx-platform/aegisx-starter/commit/ce2528ef845369a1abb8c81f77bd300031fcfada))
* **budget-types:** ลบประเภทงบซ้ำซ้อนที่ไม่มีใครใช้ ([007be88](https://github.com/aegisx-platform/aegisx-starter/commit/007be8891e471342d4bec9be9541769c5f67962c))
* **budget:** address PR [#275](https://github.com/aegisx-platform/aegisx-starter/issues/275) review (reopen atomicity, deterministic resolve, cache) ([9f9f54d](https://github.com/aegisx-platform/aegisx-starter/commit/9f9f54d7979407ec4609cc1b20d33802e63b1470))
* **budget:** address PR [#276](https://github.com/aegisx-platform/aegisx-starter/issues/276) review round 2 ([4dae355](https://github.com/aegisx-platform/aegisx-starter/commit/4dae3556253bf3aab61ba8c0451d2e66b75054b1))
* **budget:** allocation total = SUM(sources) เสมอ ไม่บวกสะสม + reopen ปล่อย allocation ([8f8f082](https://github.com/aegisx-platform/aegisx-starter/commit/8f8f082dac3098562534948aab9a77c614662ab6))
* **budget:** reject/hardDelete release allocation แบบเดียวกับ reopen (flow ล้อกัน) ([04ac2dc](https://github.com/aegisx-platform/aegisx-starter/commit/04ac2dc6b5eb188f75e88cdd0ddb047708f2cf26))
* **budget:** reopen/recalc ลบ allocation ที่ไม่เคยใช้ / retire ตัวที่มีประวัติ ([ab52b26](https://github.com/aegisx-platform/aegisx-starter/commit/ab52b2699b58d6f9a9cfb850ae155ed895b87b6b))
* **budget:** totals/monitoring นับเฉพาะ allocation ที่ active (orphan ไม่ปน) ([20b3af9](https://github.com/aegisx-platform/aegisx-starter/commit/20b3af90a6da7ec18c4c8ad522fec5d1df5ef385))
* **budget:** กัน INITIAL journal สะสมตอน re-approve แผนที่ถูกใช้ ([32c9dc2](https://github.com/aegisx-platform/aegisx-starter/commit/32c9dc2ac368ef587601172ac7857fbbdb5c299d))
* **budget:** ปรับ dialog ดูการจัดสรรงบเป็น full-screen ([6a2379c](https://github.com/aegisx-platform/aegisx-starter/commit/6a2379c8d6107011717cd12a2d8d37cfd326c04d))
* **budget:** เลิกบวกสะสมใน upsert allocation (ต้นตอ total เบิ้ล) ([bcc3f0a](https://github.com/aegisx-platform/aegisx-starter/commit/bcc3f0a508739309d9e3b9796c1c2047645a5d2d))
* **dashboard:** filter ba.is_active in v_budget_summary view ([42127d0](https://github.com/aegisx-platform/aegisx-starter/commit/42127d0a7696118a8927da520e36da5d7926defb))
* **inventory:** ลบ drug_groups ชื่อเป็นรหัสตัวเลขที่ไม่มียาผูก ([8724cec](https://github.com/aegisx-platform/aegisx-starter/commit/8724cec49e9cf7167da7eb4e6af41f2132ab0e56))
* **master-data:** migrate master-data page to ax-page-shell layout standard ([d1d354f](https://github.com/aegisx-platform/aegisx-starter/commit/d1d354f227d48095d4f7b1e9ce5ac456680dd658))
* **master-data:** move purchase-method-subtypes to Operations category in launcher ([15ee620](https://github.com/aegisx-platform/aegisx-starter/commit/15ee62098e76d0b81db2b207892d95b019ebead2))
* **pr-pdf:** committee ๗/๘ แสดงชื่อ|ตำแหน่ง|บทบาท บรรทัดเดียวตาม Word ([b5cc03a](https://github.com/aegisx-platform/aegisx-starter/commit/b5cc03acd93b450d1fc32f47e6f76ba067b3310d))
* **pr-pdf:** indent รายชื่อกรรมการให้อยู่ใต้หัวข้อ ๘.๑/๘.๒ ([b330284](https://github.com/aegisx-platform/aegisx-starter/commit/b330284ec271fb0135fe1ad5d4569b0b3a0a18fa))
* **pr-pdf:** restructure ข้อ ๗/๘ + ข้อ ๖ ตาม Word ตัวอย่าง ([522c27e](https://github.com/aegisx-platform/aegisx-starter/commit/522c27ecbdd06bda8b02a8804ef8c847eb425e32))
* **pr-pdf:** กรรมการ ๘.๑/๘.๒ รวมบรรทัดเดียว ชื่อ ตำแหน่ง บทบาท เว้นวรรค ([9740272](https://github.com/aegisx-platform/aegisx-starter/commit/974027274438d346fee10270d781a66ac9e7975a))
* **pr-pdf:** จัด layout ๘.๑/๘.๒ + รายชื่อกรรมการตาม Word ([03781c2](https://github.com/aegisx-platform/aegisx-starter/commit/03781c2185ea9802bda02c65349947a85a983c24))
* **pr-pdf:** จัดบทบาทกรรมการ ๗/๘ ชิดขวาสุด (alignment right) ตาม Word ([cb14633](https://github.com/aegisx-platform/aegisx-starter/commit/cb146335c1394a06825a85fc7c5bbe1e167c0f13))
* **pr-pdf:** ปรับ government report ให้ตรง Word ตัวอย่าง + ลบหน้าเปล่า ([1443d8c](https://github.com/aegisx-platform/aegisx-starter/commit/1443d8cda0b083622e4714d39b13a424ccf56ba2))
* **pr-pdf:** เยื้องรายชื่อกรรมการให้อยู่ใต้ชื่อหัวข้อ ๘.๑/๘.๒ ([a78df6b](https://github.com/aegisx-platform/aegisx-starter/commit/a78df6b23be77c273f0949de95cd10705e89c870))
* **procurement:** fix PO form indent, grand-total row, winner PDF layout ([7aaaaa4](https://github.com/aegisx-platform/aegisx-starter/commit/7aaaaa454e1ab01addf73bf1d6260aa3771d0e90))
* **procurement:** remove vendor business type from winner announcement PDFs ([181ceff](https://github.com/aegisx-platform/aegisx-starter/commit/181ceff1990ea36d6d035aebb3d61d02c941c96f))
* **procurement:** คุมงบรายตัวยาผ่าน budget_allocation_sources ([bf58ebd](https://github.com/aegisx-platform/aegisx-starter/commit/bf58ebdd677d66cd3afbad03db7f211850247463))
* **procurement:** แสดงชื่อผู้ทำรายการในแบบฟอร์มปริ้นทะเบียนเจ้าหนี้การค้า ([ebb93af](https://github.com/aegisx-platform/aegisx-starter/commit/ebb93af75bafe67fe911435ac442aa9d06cd5709))
* **reports:** migrate reports-launcher to ax-page-shell layout standard ([19254b9](https://github.com/aegisx-platform/aegisx-starter/commit/19254b9704735faa5b43a6aaae3e096ccaf6a038))
* **seed:** correct purchase_method_subtypes data per พ.ร.บ. มาตรา 56(2) — ก-ซ ([f3f61d8](https://github.com/aegisx-platform/aegisx-starter/commit/f3f61d8603820a4b0ff9758acf6ce7d31a85abdd))


### Features

* **budget:** resolve budget category from plan + expose budget ids on allocation ([a312932](https://github.com/aegisx-platform/aegisx-starter/commit/a312932bbd04b54123f6f89942f1a28002964f4b))
* **drug-generics:** เพิ่มช่องประเภทงบ/หมวดงบในฟอร์มยาสามัญ + ลบ dead code ([066f4f1](https://github.com/aegisx-platform/aegisx-starter/commit/066f4f185f3bb25a706451c0fac7f17def0961af))
* **drug-registry:** show drug_code + trade_name columns alongside generic info ([6307339](https://github.com/aegisx-platform/aegisx-starter/commit/63073397d3365ffa7e26505984719f163431b309))
* **master-data:** add purchase-method-subtypes frontend CRUD module ([9a77250](https://github.com/aegisx-platform/aegisx-starter/commit/9a77250babd1c8b20b489cd8692ef8104d6bdba5))
* **procurement:** add purchase-method-subtypes to procurement launcher menu ([bad8c09](https://github.com/aegisx-platform/aegisx-starter/commit/bad8c09ba3df044636514989d6550812b7e4b973))
* **procurement:** เลือกแค่แหล่งเงินใน PR forms หมวดงบ derive จากแผน ([2e6b4b8](https://github.com/aegisx-platform/aegisx-starter/commit/2e6b4b82da0c468f1b303019bb64f4e27dffa07d))
* **purchase-orders:** add sync-config button to PO edit dialog ([59f64c0](https://github.com/aegisx-platform/aegisx-starter/commit/59f64c0a2676f95f9bac20e3918c58cd961b855b))
* **purchase-requests:** click มีสัญญา badge to view contract details ([a0461d4](https://github.com/aegisx-platform/aegisx-starter/commit/a0461d4aa082ffff44c52d399181c471f35f284a))
* **settings:** add default_selection_criteria to hospital settings and PR dialog ([c74f4f3](https://github.com/aegisx-platform/aegisx-starter/commit/c74f4f3bebc8d4374f492ac6a897e5fe952d6df2))
* **theme:** บังคับใช้ธีม Light เท่านั้น + ลบ theme switcher ออกจาก top bar ([9bd52eb](https://github.com/aegisx-platform/aegisx-starter/commit/9bd52eb3891e4e3eea887393f4f462a0cfda559e))
...
- **contracts:** address PR review — pack options keyed by drugId, no edit-time mutation ([10522af](https://github.com/aegisx-platform/aegisx-starter/commit/10522af424829d9c2e0d351ec694938dd33de95b))
- **contracts:** package is a dropdown from drug pack-ratios, not free text ([37f93ec](https://github.com/aegisx-platform/aegisx-starter/commit/37f93ecfc5f170b78e70749270d6b6b828b15053))
- **fiscal-years:** filter PR-create allocation picker by the selected fiscal year ([15e93a1](https://github.com/aegisx-platform/aegisx-starter/commit/15e93a1f648526bbd553aa91e7823c523b889ff1))
- **fiscal-years:** guard allocation reload races + don't clobber selection (review r3) ([5a2446b](https://github.com/aegisx-platform/aegisx-starter/commit/5a2446b0fed863e0152260c9e61bfcd04c939a63))
- **fiscal-years:** guard lifecycle transitions + seed always sets a current year ([d26fb3d](https://github.com/aegisx-platform/aegisx-starter/commit/d26fb3d1058bfbafe185c1bbeac95bc196b996a6))
- **fiscal-years:** pr-create year default + concurrent-create 409 + timer cleanup ([31e7727](https://github.com/aegisx-platform/aegisx-starter/commit/31e77272c5bed2661718ff78d72c9ed4bab3b182))
- **fiscal-years:** single load on year default + OnPush on filter components ([7be6d48](https://github.com/aegisx-platform/aegisx-starter/commit/7be6d48dc857c54f0285ea4c50f91aca6ae76966))
- **fiscal-years:** user audit ids are UUID not int + serialize timestamps + drift marker ([c90c3ff](https://github.com/aegisx-platform/aegisx-starter/commit/c90c3ff10db6ecac3bd5d75080f162d6c77adee1))
- **fiscal-years:** ช่วงเวลา แสดงปี พ.ศ. ในตารางปีงบประมาณ ([4b6d071](https://github.com/aegisx-platform/aegisx-starter/commit/4b6d07132a5b9d1165b15de62e6f938964650318))
- **platform:** adopt unified layout standard in platform shell ([5ced051](https://github.com/aegisx-platform/aegisx-starter/commit/5ced051e6058c2b82edb71395baa64a6354e0eea))
- **procurement:** action menu — ปุ่มเรียงแนวนอน + คลิกนอกเมนูปิดได้ ([c200e1b](https://github.com/aegisx-platform/aegisx-starter/commit/c200e1b48593a9be706b90b9f5190f53f6ca597c))
- **procurement:** dismiss snackbar 'กำลังสร้าง...' ตอน preview dialog เปิด ([9aa4e68](https://github.com/aegisx-platform/aegisx-starter/commit/9aa4e6818deeedc6f95faa94b4f5efca4e9b9ead))
- **procurement:** exclude computed has_contract from base column filter (42703) ([2dc55ce](https://github.com/aegisx-platform/aegisx-starter/commit/2dc55ce0793ae054a77e6155f4cb64a3c59f18a9))
- **procurement:** generic fallback for null drug_id in has_contract (PR review) ([2580db4](https://github.com/aegisx-platform/aegisx-starter/commit/2580db447fff79cbeb0bfaab8ccbfe78e33b65e5))
- **procurement:** guard contract enrichment with try/catch + typed genericIds ([cd47695](https://github.com/aegisx-platform/aegisx-starter/commit/cd476954b03b6c6cc2f1e568e59af41a9702893d))
- **procurement:** match has_contract by drug_id (exact รหัสยา) not generic ([b5c2c20](https://github.com/aegisx-platform/aegisx-starter/commit/b5c2c204d0ced1f155092573f2c1a6b1e4bf8b1b))
- **procurement:** show PR-list request date in Thai (B.E.) ([56da8a1](https://github.com/aegisx-platform/aegisx-starter/commit/56da8a19b735caa08f106962217226d6ac21b2e6))
- **procurement:** theme the PR-list PO link as an ax-token chip ([74bcc9d](https://github.com/aegisx-platform/aegisx-starter/commit/74bcc9ddfe212d410cc6d1e5855d87d893a3286e))
- **procurement:** เนื้อหา preview PDF เต็มความสูง ([198d238](https://github.com/aegisx-platform/aegisx-starter/commit/198d238b00134521ac27d4d8bbd0b15817f7ca56))
- **purchase-orders:** address code-review on contract auto-suggest ([9e7e27e](https://github.com/aegisx-platform/aegisx-starter/commit/9e7e27e987fa10800ed0466304590bbf3bece483))
- **purchase-orders:** จัดคอลัมน์ยอดเงินที่จัดซื้อเป็นแถวเดียว ([b424b56](https://github.com/aegisx-platform/aegisx-starter/commit/b424b565692dd0488382fb64b38b5899936b0911))
- **purchase-orders:** ปรับบันทึกข้อความตรวจรับฯ เพิ่มเติม ([372d0a6](https://github.com/aegisx-platform/aegisx-starter/commit/372d0a6cf6c4725cda4b61d3719c4189d069c77d))
- **purchase-orders:** ปรับฟอร์แมตบันทึกข้อความตรวจรับฯ ขออนุมัติเบิกจ่าย ([3245879](https://github.com/aegisx-platform/aegisx-starter/commit/32458793b2f79785e4ab442ca902ddaf2ecde9ac))
- **purchase-orders:** ปรับสัดส่วนคอลัมน์ตารางงบประมาณ (ข้อเสนอ) ([1c0e124](https://github.com/aegisx-platform/aegisx-starter/commit/1c0e124a8eaa03e63110423478261b8755eea22e))
- **purchase-requests:** default subtype to (ข) เงื่อนไขวงเงิน on new PR ([c1e7351](https://github.com/aegisx-platform/aegisx-starter/commit/c1e7351dcabd722aacb3cb18079ad324ee576a36))
- **purchase-requests:** dialog ตัวอย่าง PDF (รายงานขอซื้อ) เต็มจอ ([53f94ea](https://github.com/aegisx-platform/aegisx-starter/commit/53f94ea663068e128dbaf4f746f6fb00b946c13e))
- **purchase-requests:** form ในdialog เต็มความกว้างตอน full-screen ([bf3cb52](https://github.com/aegisx-platform/aegisx-starter/commit/bf3cb524c9719ba09da44d646b987f1bb7d1c9d4))
- **purchase-requests:** show subtype on default method + auto-select first budget ([686adab](https://github.com/aegisx-platform/aegisx-starter/commit/686adab60d8de91cb5bfa4de8fd47678a7ccd139))
- **purchase-requests:** ข้อมูลระบบ ใน dialog ดูใบขอซื้อ ([6d51f34](https://github.com/aegisx-platform/aegisx-starter/commit/6d51f34876e89eda9db54b9e1849e2171f289e3d))
- **purchase-requests:** ปุ่ม print + เมนู (⋮) เรียงแนวนอน ([2dcada1](https://github.com/aegisx-platform/aegisx-starter/commit/2dcada1e5891c6effa717d401e7fef65b29dbfcf))
- **quick-build:** resolve template compile errors in wizard dialog ([555d58a](https://github.com/aegisx-platform/aegisx-starter/commit/555d58a84d4c0725608e477b0c4c0ccae54c1425))
- **quick-build:** แผนก dropdown ไม่ขึ้น option (field name mismatch) ([4bbeffe](https://github.com/aegisx-platform/aegisx-starter/commit/4bbeffef45454c74ada9d6a1286c77e69ad33c96))
- **web:** contract filter label ทุกสัญญา → ทั้งหมด for consistency ([dcc7acb](https://github.com/aegisx-platform/aegisx-starter/commit/dcc7acbf198e7784b5650a0b9ad1d63fbf95e346))
- **web:** key items-table expand state by row to avoid cross-row collision ([7955bfa](https://github.com/aegisx-platform/aegisx-starter/commit/7955bfa15aeb83d28075d2c852046d028285117c))
- **web:** register Thai locale data to stop DatePipe NG0701 crash ([859d208](https://github.com/aegisx-platform/aegisx-starter/commit/859d208d9fce9d17da38404d32adf4b0d6bad96e))

### Features

- **contracts:** add Excel/CSV bulk import backend (header + items) ([c84f60c](https://github.com/aegisx-platform/aegisx-starter/commit/c84f60c1b42b8540e60cb514d45b6ffdaa67c6a9))
- **contracts:** add Excel/CSV bulk import dialog (frontend) ([6d4785c](https://github.com/aegisx-platform/aegisx-starter/commit/6d4785c4bb1dd4c65a5d4944ef91932a93618ce2))
- **contracts:** add package_size + package_unit to contract_items (migration) ([1248889](https://github.com/aegisx-platform/aegisx-starter/commit/1248889c99a3ef0ffe5d707f0cbe91b0c21ca009))
- **contracts:** full-screen create/edit modal + package/totals in view ([210a966](https://github.com/aegisx-platform/aegisx-starter/commit/210a9668ef71e34e1c569f2cca433fbdfa3ab8ca))
- **contracts:** persist + return package_size/package_unit on contract items ([a4c77d4](https://github.com/aegisx-platform/aegisx-starter/commit/a4c77d4bced3dc0915370a6a21ba73f60e56130b))
- **contracts:** purchase qty label, package inputs + totals in form ([d912d9c](https://github.com/aegisx-platform/aegisx-starter/commit/d912d9c6feaaf665ba5987e57c614f83b59b877e))
- **fiscal-years:** add fiscal_years table + single-current index + back-fill seed ([f80ecc0](https://github.com/aegisx-platform/aegisx-starter/commit/f80ecc00e2bb9920c505185a3c360d8ea864c53b))
- **fiscal-years:** add fiscal-year filter dropdown to PR list (default current) ([e85f7c9](https://github.com/aegisx-platform/aegisx-starter/commit/e85f7c920c0a5df2b9bb5a1ceb8f7d5576a4ea25))
- **fiscal-years:** add TypeBox schemas and types ([8067296](https://github.com/aegisx-platform/aegisx-starter/commit/8067296af35c0752e9dbab0142b89c60530c81b4))
- **fiscal-years:** admin management page (list + create + activate/set-current) ([d627294](https://github.com/aegisx-platform/aegisx-starter/commit/d627294373ecef007afce5141ea590ec87225a0c))
- **fiscal-years:** block creating PR/plan in a CLOSED fiscal year ([ec31774](https://github.com/aegisx-platform/aegisx-starter/commit/ec31774529e7aa05eeb40ee24c9cccd20a4f55e8))
- **fiscal-years:** controller ([9a46a1c](https://github.com/aegisx-platform/aegisx-starter/commit/9a46a1ca624f341775bd1629f3b2845b2e1c608c))
- **fiscal-years:** default budget screens to current fiscal year (soft default) ([fb92a16](https://github.com/aegisx-platform/aegisx-starter/commit/fb92a16ea2fae8db833fd2e1a68214147cd10756))
- **fiscal-years:** extend period-close guard to operations/budgetRequests ([ca8d4d5](https://github.com/aegisx-platform/aegisx-starter/commit/ca8d4d5aec230608932dfbcf44116bbf8c708729))
- **fiscal-years:** lifecycle service + unit tests ([840cd3e](https://github.com/aegisx-platform/aegisx-starter/commit/840cd3eafac6ca1a2512a62679b8c99bad929e05))
- **fiscal-years:** repository with current + transition helpers ([25eb146](https://github.com/aegisx-platform/aegisx-starter/commit/25eb146a93e0a78d3259ac0cfd188d2b11a74ab3))
- **fiscal-years:** routes + plugin + master-data registration ([18fcf83](https://github.com/aegisx-platform/aegisx-starter/commit/18fcf83f288a6355ea34ca50d4596c37f3b02505))
- **fiscal-years:** seed fiscalYears role + permissions ([1346d95](https://github.com/aegisx-platform/aegisx-starter/commit/1346d95b552448cdafffaed9fb6c67574f03cc4c))
- **fiscal-years:** source PR + budget-plan year dropdowns from governance ([98fc750](https://github.com/aegisx-platform/aegisx-starter/commit/98fc75082006e00a7cd6c08e18c73e3bea12f026))
- **fiscal-years:** stat cards follow the selected fiscal year (PR + budget-requests + allocations) ([d0be1f2](https://github.com/aegisx-platform/aegisx-starter/commit/d0be1f2b28296065f02c396b1f4461ae039c5fc6))
- **fiscal-years:** stats endpoints accept optional fiscal_year filter (PR + budget-requests + allocations) ([d562908](https://github.com/aegisx-platform/aegisx-starter/commit/d562908baebca7d8c4c70bf32f27229e83b7fdfe))
- **fiscal-years:** year-end close marks fiscal year CLOSED + stock-shortage uses governed current year ([de2754e](https://github.com/aegisx-platform/aegisx-starter/commit/de2754eac91a57883016a39a8c6e10e689fc7373))
- **pdf-fonts:** เพิ่ม glyph U+200B (zero-width space) ใน THSarabunNew ([3c48427](https://github.com/aegisx-platform/aegisx-starter/commit/3c4842706d46bfecfd2089f4fa60f658afb64d01))
- **procurement:** add buildItemContractMatch helper with unit tests ([c27be3c](https://github.com/aegisx-platform/aegisx-starter/commit/c27be3c0ab256e3d8a8ede724825098b5c5ad930))
- **procurement:** add drug_id to ContractPrice for TPU-level matching ([c326eb8](https://github.com/aegisx-platform/aegisx-starter/commit/c326eb8271d954ad1422429b93eb2142a6953091))
- **procurement:** add has_contract display and filter to purchase-request list ([68ece11](https://github.com/aegisx-platform/aegisx-starter/commit/68ece11a7e7f06f87e85a71201187c340c56d7b1))
- **procurement:** declutter PR list — 11 cols down to 7 ([3755ce0](https://github.com/aegisx-platform/aegisx-starter/commit/3755ce04e2934983b3d13706a4d53afb343ccde2)), closes [hi#signal](https://github.com/hi/issues/signal)
- **procurement:** distinct expand bg + strip its icon/heading ([388e63b](https://github.com/aegisx-platform/aegisx-starter/commit/388e63bcf4785c1f2e458d2cb860cf46282caebd))
- **procurement:** enrich PR detail items with contract_match ([556d710](https://github.com/aegisx-platform/aegisx-starter/commit/556d7109a1ca0dbf58a92868ef5c99b7c58f5340))
- **procurement:** expand shows only the drug items ([9d949ac](https://github.com/aegisx-platform/aegisx-starter/commit/9d949acd3acd2d11cca63d5eca5e483a524c8679))
- **procurement:** expose contract_match in PR item response schema ([12e5912](https://github.com/aegisx-platform/aegisx-starter/commit/12e5912972023e2ebf98c8000133827a15c39cf8))
- **procurement:** link PR list rows to their PO ([24cddb0](https://github.com/aegisx-platform/aegisx-starter/commit/24cddb0072ed2883862f4617b5ba356540a28a0b))
- **procurement:** move PO link to first column beside PR number ([6fbbd7e](https://github.com/aegisx-platform/aegisx-starter/commit/6fbbd7e4dc1eefb2dfedc265b49b732c4ecc3a64))
- **procurement:** show drug items in PR list expand row ([54e8ab2](https://github.com/aegisx-platform/aegisx-starter/commit/54e8ab24e03f9b3e43c28c4a97046f20acfd36a5))
- **procurement:** show purchase method under drug name (drop purpose preview) ([b421645](https://github.com/aegisx-platform/aegisx-starter/commit/b42164525e17c4458d12e3ebc2d69927bbe68cc2))
- **purchase-orders:** auto-suggest contract in PO form ([285b2a0](https://github.com/aegisx-platform/aegisx-starter/commit/285b2a010914d867ccf69b1f7c7338393ec4f3de))
- **purchase-orders:** surface linked contract — display, filter & print ([bddf147](https://github.com/aegisx-platform/aegisx-starter/commit/bddf147aba0512bd122a0142662c7979034c1eb6))
- **purchase-orders:** แยกปุ่มพิมพ์เอกสารในแถว PO list (1 คลิก) ([664921d](https://github.com/aegisx-platform/aegisx-starter/commit/664921dd6a0ceecda80d3b77d4c66e4a5837ac81)), closes [#pdfMenu](https://github.com/aegisx-platform/aegisx-starter/issues/pdfMenu)
- **purchase-requests:** dialog ใบขอซื้อ (ดู/สร้าง/แก้ไข) เป็น full-screen ([a75411d](https://github.com/aegisx-platform/aegisx-starter/commit/a75411d0b8c2dd8487fdc5faa5aa230d91494c3e))
- **purchase-requests:** แยกปุ่มพิมพ์รายงานขอซื้อขอจ้างในแถว PR list ([aee90dc](https://github.com/aegisx-platform/aegisx-starter/commit/aee90dc3121a690860ad70bf6b6edb3429cb9122))
- **quick-build:** commit endpoint — PR+PO per vendor group with partial reporting ([ef5040b](https://github.com/aegisx-platform/aegisx-starter/commit/ef5040bed5e082ac09f55f5e6dc40975702dd946))
- **quick-build:** Excel template + preview endpoint (parse + resolve + errors) ([0ef47e4](https://github.com/aegisx-platform/aegisx-starter/commit/0ef47e431e9f457870f53fabcefbd6f0b11e64d3))
- **quick-build:** Excel→PR+PO wizard dialog (upload → preview/edit → result) ([2a80060](https://github.com/aegisx-platform/aegisx-starter/commit/2a80060c3a41843443f5e9de24db927e13f67bd3))
- **quick-build:** resolve engine — pure proposal helper + batch last-purchase query ([e41e5bb](https://github.com/aegisx-platform/aegisx-starter/commit/e41e5bb22182b4c82fc9784ccf4beae02b00cf90))
- **web:** add optional contract column to shared items-table ([1352a0b](https://github.com/aegisx-platform/aegisx-starter/commit/1352a0b1d243a21f121425e427e317706225af01))
- **web:** contract badge + filter on PR list ([101e9b7](https://github.com/aegisx-platform/aegisx-starter/commit/101e9b7038b838f922d9f6f208b910f2216c5b58))
- **web:** contract badge in PR quick-view dialog ([9400713](https://github.com/aegisx-platform/aegisx-starter/commit/9400713a630eb2c57c3e9b6a69ca5cfc40ea93e9))
- **web:** contract column on approve page + wire approve action in PR list ([602417f](https://github.com/aegisx-platform/aegisx-starter/commit/602417f6d98d2549ea82adb54d447300d0e82a31))
- **web:** contract expiry badge on row + expandable all rows, expand shows only drug items ([faeb4c9](https://github.com/aegisx-platform/aegisx-starter/commit/faeb4c95f00e31235884bd50b34f2e0bb38220d7))
- **web:** contracts expand shows drug items + expiry status badge + days remaining ([c725e60](https://github.com/aegisx-platform/aegisx-starter/commit/c725e6076c4d21a86203fa5310c4eb919cd56c80))
- **web:** enable create-PO-from-PR button on PR quick-view ([7a19627](https://github.com/aegisx-platform/aegisx-starter/commit/7a19627f0affb5ce6a20e004e3e6199a1d8ba98e))
- **web:** show contract availability column on PR detail ([f4de1ca](https://github.com/aegisx-platform/aegisx-starter/commit/f4de1ca98be2cc81ba0ec8a27961ee07b937042c))
- **web:** show contract availability in create-PO-from-PR dialog ([fac7d84](https://github.com/aegisx-platform/aegisx-starter/commit/fac7d843937fd7d6fcdb253258a484ce5fb2065f))
- **web:** show drug_code + generic_name on contract-items list ([aa31396](https://github.com/aegisx-platform/aegisx-starter/commit/aa313963a77f718a2393137f9baa6a73d5bb27e7))
- **web:** show drug_code + trade_name under generic in PR items table ([7cb4782](https://github.com/aegisx-platform/aegisx-starter/commit/7cb47825a63ef27eec35cb24029072b2dbc5e2b2))
...
- **.claude/skills/subagent-driven-strict:** clarify Gate A semantics, expand triggers, fix subagent_type guidance ([865eacf](https://github.com/aegisx-platform/aegisx-starter/commit/865eacf420c1798ca47609f7bc4017c8149e51ab))
- 3 critical code-review findings from PR [#114](https://github.com/aegisx-platform/aegisx-starter/issues/114) retrospective (B1+C1+A4) ([1eced86](https://github.com/aegisx-platform/aegisx-starter/commit/1eced86a9e93128b59c16d32757079a9ee6110ca)), closes [#106](https://github.com/aegisx-platform/aegisx-starter/issues/106)
- 4 code-review findings from PR [#109](https://github.com/aegisx-platform/aegisx-starter/issues/109) — real bugs + FK guards ([3b463e0](https://github.com/aegisx-platform/aegisx-starter/commit/3b463e04a516c3d5affbc065d5a1d0ec22e4635c)), closes [#106](https://github.com/aegisx-platform/aegisx-starter/issues/106) [#106-class](https://github.com/aegisx-platform/aegisx-starter/issues/106-class) [#108](https://github.com/aegisx-platform/aegisx-starter/issues/108) [#110](https://github.com/aegisx-platform/aegisx-starter/issues/110)
- **api:** finish DATE-shift cleanup — backend doc numbers + dispense response ([696a06e](https://github.com/aegisx-platform/aegisx-starter/commit/696a06e1932bde83fc79095ad039a1b40305c155)), closes [97/#98](https://github.com/aegisx-platform/aegisx-starter/issues/98) [#101](https://github.com/aegisx-platform/aegisx-starter/issues/101)
- **api:** finish DATE-shift cleanup — local-tz dates across backend ([b5c47db](https://github.com/aegisx-platform/aegisx-starter/commit/b5c47dbacc604c8a37c132ed14baee34155fd418))
- **budget-requests:** complete the reopen audit round-trip — read path + generic PUT ([4544089](https://github.com/aegisx-platform/aegisx-starter/commit/4544089dc444fd3f896594d3d5b7019d74746569)), closes [#109](https://github.com/aegisx-platform/aegisx-starter/issues/109) [#109](https://github.com/aegisx-platform/aegisx-starter/issues/109) [#109](https://github.com/aegisx-platform/aegisx-starter/issues/109) [#109](https://github.com/aegisx-platform/aegisx-starter/issues/109)
- **deploy:** set TZ=Asia/Bangkok on api container ([4ea8afc](https://github.com/aegisx-platform/aegisx-starter/commit/4ea8afccdc360e7441ac99f7395b99d0d89b4630)), closes [99/#101](https://github.com/aegisx-platform/aegisx-starter/issues/101)
- **disposal:** align create payload with BE schema — 3 missing required fields + multi-step items ([04c090f](https://github.com/aegisx-platform/aegisx-starter/commit/04c090f10d42c26ee90e2de278874b053f94d5ee))
- **disposal:** align FE status enum with backend (APPROVED=L1, FINAL_APPROVED=L2) ([487019c](https://github.com/aegisx-platform/aegisx-starter/commit/487019c68ec04dae6ff92d4f47d10facc319603c))
- **disposal:** align FE workflow payloads with backend body schemas ([66330fe](https://github.com/aegisx-platform/aegisx-starter/commit/66330fef1759b16cc595d613d8dbb1bfe8247ed8))
- **disposal:** align user/location JOIN columns with actual schema ([fc21dc6](https://github.com/aegisx-platform/aegisx-starter/commit/fc21dc6cb950864c4169e1af2c658cbf56331f98))
- **disposal:** allow comma-separated status filter + add PENDING_APPROVAL ([f55a205](https://github.com/aegisx-platform/aegisx-starter/commit/f55a205c8e2ed62eb256bef5f7640a58717b0138))
- **disposal:** attachments reload on entityId change + memo date wall-clock ([d95945e](https://github.com/aegisx-platform/aegisx-starter/commit/d95945e2d00f6dff9f9abcb82282130e460e411f)), closes [#9](https://github.com/aegisx-platform/aegisx-starter/issues/9) [#6](https://github.com/aegisx-platform/aegisx-starter/issues/6)
- **disposal:** clean up review LOW findings ([#10](https://github.com/aegisx-platform/aegisx-starter/issues/10)–[#14](https://github.com/aegisx-platform/aegisx-starter/issues/14)) ([18f32bc](https://github.com/aegisx-platform/aegisx-starter/commit/18f32bc135d1d2bb3817c59f608a9a7f6579045a)), closes [#11](https://github.com/aegisx-platform/aegisx-starter/issues/11) [#12](https://github.com/aegisx-platform/aegisx-starter/issues/12) [#13](https://github.com/aegisx-platform/aegisx-starter/issues/13)
- **disposal:** clone reads trade_name/unit_name from BE items response ([ec62a1f](https://github.com/aegisx-platform/aegisx-starter/commit/ec62a1f980277d03f4c4d650c76ce7f06a421bbf))
- **disposal:** detail page — @if/[@for](https://github.com/for) + OnPush + token colors ([52d7896](https://github.com/aegisx-platform/aegisx-starter/commit/52d7896c0b4c4d034d38cb90a356e1c77463d529))
- **disposal:** drop legacy stats KPI block from list header ([a9b59e7](https://github.com/aegisx-platform/aegisx-starter/commit/a9b59e72a50292d21e3f3032b0bcf0847db24fd6))
- **disposal:** edit-gate resets L1-approved (APPROVED), not dead APPROVED_L1 ([3077c43](https://github.com/aegisx-platform/aegisx-starter/commit/3077c43f39833efa25b611a827e25480fea09f5b)), closes [#1](https://github.com/aegisx-platform/aegisx-starter/issues/1) [#2](https://github.com/aegisx-platform/aegisx-starter/issues/2)
- **disposal:** item picker Add button stuck disabled after autocomplete pick ([da7d819](https://github.com/aegisx-platform/aegisx-starter/commit/da7d819d70ff1e799784857c8521633d1b2fae01))
- **disposal:** memo PDF — make signature dotted line longer ([8e74ec2](https://github.com/aegisx-platform/aegisx-starter/commit/8e74ec2814dcfe379bffa444ede2cf0437328b33))
- **disposal:** memo PDF signature blocks aligned + equal width ([f96fde6](https://github.com/aegisx-platform/aegisx-starter/commit/f96fde637384b0c25332ecf33d5d2d25e3de0c7c))
- **disposal:** memo PDF signature blocks flush right + rows aligned ([75ac9de](https://github.com/aegisx-platform/aegisx-starter/commit/75ac9dec5dfc830dbb2d3776c1e1fa5bdd6628f1))
- **disposal:** memo PDF signature line shorter + name truly centered ([a16f844](https://github.com/aegisx-platform/aegisx-starter/commit/a16f844d67498987066d424464fc28e28124692a))
- **disposal:** memo PDF signature uses table — sig+dots glued, name centers under ([349d1de](https://github.com/aegisx-platform/aegisx-starter/commit/349d1de84412b07bdaa463d59a87e70fd37e3cca))
- **disposal:** memo section reactive forms (was broken ngModel+signal) ([bc7f3bb](https://github.com/aegisx-platform/aegisx-starter/commit/bc7f3bb9d3845b48605a3104cf5a481ed623cc2c))
- **disposal:** pdf header shows hospital name above title ([fb038f8](https://github.com/aegisx-platform/aegisx-starter/commit/fb038f8db8b024ed1f8096cd1a5df2bec1b99c34))
- **disposal:** pdf print uses authenticated dialog preview ([455c3b0](https://github.com/aegisx-platform/aegisx-starter/commit/455c3b02f6998ebc2242176e06cc44ee0f62091a))
- **disposal:** pdf uses THSarabunNew Thai font + portrait orientation ([653f852](https://github.com/aegisx-platform/aegisx-starter/commit/653f852b400d552f8bae1b862240242f21e96959))
- **disposal:** replace SchemaRefs.OperationResult with permissive response schema ([ca0f80d](https://github.com/aegisx-platform/aegisx-starter/commit/ca0f80dca58afaa54c0bf164d7fdb2104f81fb12))
- **disposal:** repository transformToEntity maps 8 memo fields ([78fb9da](https://github.com/aegisx-platform/aegisx-starter/commit/78fb9da5439d0eab6b0497820de5833813871d9b)), closes [#93](https://github.com/aegisx-platform/aegisx-starter/issues/93)
- **disposal:** request_number ≤20 chars + quantity integer-only ([7a40dc3](https://github.com/aegisx-platform/aegisx-starter/commit/7a40dc3cd79502f7425e9ce31ffeb7158794b18c))
- **disposal:** selectedLot/totalCost must be methods, not computed signals ([7cbd5b9](https://github.com/aegisx-platform/aegisx-starter/commit/7cbd5b924b52674bc4f85729b247cbe080fb86f5))
- **disposal:** surface real BE errors + add lac-check + no-error-swallowing skills ([6591c4b](https://github.com/aegisx-platform/aegisx-starter/commit/6591c4bac33c5f011286a338851d136cca966d67))
- **disposal:** thai error messages + location/requester name display ([1d2f602](https://github.com/aegisx-platform/aegisx-starter/commit/1d2f60244fc2251a93d861322b3710c770a61263))
- **disposal:** transform update response, numeric edit-log diff, DATE wall-clock, memo positions ([9f6256e](https://github.com/aegisx-platform/aegisx-starter/commit/9f6256ece8136fbef85a5748284e2e9ec2332878)), closes [#4](https://github.com/aegisx-platform/aegisx-starter/issues/4) [#5](https://github.com/aegisx-platform/aegisx-starter/issues/5) [#6](https://github.com/aegisx-platform/aegisx-starter/issues/6) [#8](https://github.com/aegisx-platform/aegisx-starter/issues/8)
- **disposal:** use /drug-lots endpoint with correct field names ([b469109](https://github.com/aegisx-platform/aegisx-starter/commit/b469109e360cfaee65b5e45897aee9a84264c2c5))
- **disposal:** use sort=field:direction format for drug-lots query ([d0fe5a7](https://github.com/aegisx-platform/aegisx-starter/commit/d0fe5a797acfb2824d1171315519f06bfed74286))
- **disposal:** workflow service must transform Date columns before returning ([e5d5d86](https://github.com/aegisx-platform/aegisx-starter/commit/e5d5d86fe9ffb6b14184da080df560aca976310d))
- **disposal:** workflow transformRow converts letter_date Date to string ([b991983](https://github.com/aegisx-platform/aegisx-starter/commit/b9919830bc00c11059344ac9bbdc4cb672cca26e))
- **distributions:** child-BIN support + wrapper-aware error mapping (code review) ([0cc99e5](https://github.com/aegisx-platform/aegisx-starter/commit/0cc99e5337a55c18d5f4be0b91740f3e208c066a)), closes [#1](https://github.com/aegisx-platform/aegisx-starter/issues/1) [#2](https://github.com/aegisx-platform/aegisx-starter/issues/2) [#3](https://github.com/aegisx-platform/aegisx-starter/issues/3) [#4](https://github.com/aegisx-platform/aegisx-starter/issues/4) [#89](https://github.com/aegisx-platform/aegisx-starter/issues/89)
- **distributions:** code-review findings on unified approve+dispense ([21c97da](https://github.com/aegisx-platform/aegisx-starter/commit/21c97dadf4459860d1852cb917831267bbbe1e9a)), closes [#88](https://github.com/aegisx-platform/aegisx-starter/issues/88) [#1](https://github.com/aegisx-platform/aegisx-starter/issues/1) [#2](https://github.com/aegisx-platform/aegisx-starter/issues/2) [#1](https://github.com/aegisx-platform/aegisx-starter/issues/1) [#3](https://github.com/aegisx-platform/aegisx-starter/issues/3) [#4](https://github.com/aegisx-platform/aegisx-starter/issues/4) [#6](https://github.com/aegisx-platform/aegisx-starter/issues/6) [#5](https://github.com/aegisx-platform/aegisx-starter/issues/5) [#7](https://github.com/aegisx-platform/aegisx-starter/issues/7)
- **distributions:** credit destination on backorder fulfill ([7efd9f4](https://github.com/aegisx-platform/aegisx-starter/commit/7efd9f48bc575d3659f2fd246678574daceb23d7))
- **distributions:** wire bulk error log through request.log (round 2) ([67c083c](https://github.com/aegisx-platform/aegisx-starter/commit/67c083c627ace548566abc57039bf4f7af531b4f))
- **inventory:** apply formatPgDate to DATE columns across 17 repositories ([01df69e](https://github.com/aegisx-platform/aegisx-starter/commit/01df69e0b6a016c316cea44d95842b94f333794a))
- **inventory:** cleanup follow-ups from code review of 885281603 ([c860885](https://github.com/aegisx-platform/aegisx-starter/commit/c86088599fae0e431c443077971740f2a841f44f))
- **inventory:** default business DATE columns to local today, not UTC ([2c294f3](https://github.com/aegisx-platform/aegisx-starter/commit/2c294f3382f42ca6982297b572a03def30a4daa8))
- **inventory:** drug-distributions auto-PULL DATE-shift in route ([d41d81b](https://github.com/aegisx-platform/aegisx-starter/commit/d41d81b0ab7aa2814e8e0b29458c95bd26e391a2)), closes [97/#98](https://github.com/aegisx-platform/aegisx-starter/issues/98)
- **main-warehouse:** move "ตรวจสอบ & อนุมัต��" to top of ⋮ menu ([22f40d2](https://github.com/aegisx-platform/aegisx-starter/commit/22f40d23cf1b7405258c676ebb18f9f8c74d008f)), closes [#87](https://github.com/aegisx-platform/aegisx-starter/issues/87)
- **numbering:** 3 production bugs that broke /system/numbering UI ([76ba7fb](https://github.com/aegisx-platform/aegisx-starter/commit/76ba7fb5d9ebbe86d8ecb3432a9979836943959c)), closes [#90](https://github.com/aegisx-platform/aegisx-starter/issues/90)
- **numbering:** address 4 MEDIUM findings from post-ship review ([b539e5e](https://github.com/aegisx-platform/aegisx-starter/commit/b539e5ecfee18d8317a6232394b66de1bbe13d82)), closes [#90](https://github.com/aegisx-platform/aegisx-starter/issues/90)
- **numbering:** derive period_key + render tokens from Asia/Bangkok wall clock ([a7d6f0a](https://github.com/aegisx-platform/aegisx-starter/commit/a7d6f0a05f7e24d3c7672cadf210937c87bf4f05))
- **numbering:** map snake_case row → camelCase DTO in controller responses ([0f827f0](https://github.com/aegisx-platform/aegisx-starter/commit/0f827f07e00cc9533e4b62165bf6e63fee8df6ab))
- **numbering:** propagate trx to writeAudit + setCounter for override atomicity ([2ade84b](https://github.com/aegisx-platform/aegisx-starter/commit/2ade84b1c19e4c415395d5646cc40bb668a80b58)), closes [#1](https://github.com/aegisx-platform/aegisx-starter/issues/1) [#90](https://github.com/aegisx-platform/aegisx-starter/issues/90)
- **numbering:** split override-preview from audited override + filter PII ([64449b2](https://github.com/aegisx-platform/aegisx-starter/commit/64449b24e1207eebf95964ef51853d980a7d0bf0))
- **numbering:** tighten input validation + SQL-identifier defense + audit-log error envelope ([87428fe](https://github.com/aegisx-platform/aegisx-starter/commit/87428fe278a042ef269d75dd5b6de7b0c39a1659))
- **platform:** correct DATE→string root cause (rule + shared helper + gate) ([acca5cc](https://github.com/aegisx-platform/aegisx-starter/commit/acca5cc9ad9cfbe261101b17c7a32dce204e7072))
- **platform:** hospital settings search — routes, code search, UI overlap ([1089722](https://github.com/aegisx-platform/aegisx-starter/commit/1089722d8e546ec6ee34f57788817ab7b35d438c))
- **po:** wire cancel audit columns through transformToDb — PR [#106](https://github.com/aegisx-platform/aegisx-starter/issues/106) follow-up ([f67687c](https://github.com/aegisx-platform/aegisx-starter/commit/f67687cfe8a1d2c338d188cbcafa7c93e72047cf))
- **procurement:** apply completed-subtitle fix to auto steps too ([2f7cc62](https://github.com/aegisx-platform/aegisx-starter/commit/2f7cc620e786db67c024ac895d869ba4de7f3f8f))
- **procurement:** split GFMIS into separate order + inspection steps ([67b5b9e](https://github.com/aegisx-platform/aegisx-starter/commit/67b5b9ee09037fcb0e5aded26661e30eb60b8a37))
- **purchase-orders:** coerce nullable FK 0→null กัน FOREIGN_KEY_VIOLATION ตอนแก้ไข PO ([91a71ae](https://github.com/aegisx-platform/aegisx-starter/commit/91a71ae043b1f9917731ebd4eb02ce9057be37b2))
- **quality-gate:** check-design-md-sync flaky failure under pipefail ([a7e605f](https://github.com/aegisx-platform/aegisx-starter/commit/a7e605f97395162af51e623b27700e4281e50724)), closes [#113](https://github.com/aegisx-platform/aegisx-starter/issues/113)
- **quality-gate:** layer 2 marker also accepts jsdoc \* continuation ([9e9d6ba](https://github.com/aegisx-platform/aegisx-starter/commit/9e9d6ba54ee01bbcd732785f1f9101c73496a2e1)), closes [#117](https://github.com/aegisx-platform/aegisx-starter/issues/117)
- **quality:** close DATE-shift gate gaps — widen matcher + fix all legacy ([c04fc5d](https://github.com/aegisx-platform/aegisx-starter/commit/c04fc5d5f619ed08c1cb654c721abe5cc14dd0a3)), closes [#97](https://github.com/aegisx-platform/aegisx-starter/issues/97) [#101](https://github.com/aegisx-platform/aegisx-starter/issues/101) [#102](https://github.com/aegisx-platform/aegisx-starter/issues/102)
- **receipts:** 2-col delivery+invoice row + visible PO-load errors ([d626040](https://github.com/aegisx-platform/aegisx-starter/commit/d6260406444f4785256961a955c8e966ec7a29c6))
- **receipts:** align dotted signature lines across rows in e-GP PDF ([b34a1e9](https://github.com/aegisx-platform/aegisx-starter/commit/b34a1e978cd785e20dfc60c3694a467b38305523))
- **receipts:** align signature block to the right side in e-GP PDF ([ef5d55b](https://github.com/aegisx-platform/aegisx-starter/commit/ef5d55b0323474cd6d996aa66eb586069b0b6e47))
- **receipts:** allow empty items array for DRAFT quick-intake ([7023f05](https://github.com/aegisx-platform/aegisx-starter/commit/7023f055182002ec06fefd2e287566cbffcc6b80))
- **receipts:** always-on 2-col layout for quick-intake — bypass form reactivity bug ([b97a966](https://github.com/aegisx-platform/aegisx-starter/commit/b97a966185b87ccebaa2e39fa4953b352c3ac2f3))
- **receipts:** center committee name under the signature line in e-GP PDF ([851a438](https://github.com/aegisx-platform/aegisx-starter/commit/851a4384918b0cd296472dc473e3b718728eefe6))
- **receipts:** close gap between signature line and role in e-GP PDF ([997f526](https://github.com/aegisx-platform/aegisx-starter/commit/997f526abe4e4ef30af8a5fa6cc40631f44913c6))
- **receipts:** code-review followups from feature/receipt-quick-intake ([63220d0](https://github.com/aegisx-platform/aegisx-starter/commit/63220d01e5fc67251e6a8902594a3c50a183fde6))
- **receipts:** keep signature group right with fixed widths in e-GP PDF ([daba35a](https://github.com/aegisx-platform/aegisx-starter/commit/daba35a081455e1cfa86faa52834fdb607919fa6))
- **receipts:** make dotted line attach to the role in e-GP PDF ([d15a3c4](https://github.com/aegisx-platform/aegisx-starter/commit/d15a3c477657095c5daf2511a9f127ee10522608))
- **receipts:** put committee role on same line as signature in e-GP PDF ([78f2f46](https://github.com/aegisx-platform/aegisx-starter/commit/78f2f465992c0832625f8c806f7b099ef673e0c9))
- **receipts:** right-align committee name under signature line in e-GP PDF ([611931d](https://github.com/aegisx-platform/aegisx-starter/commit/611931d151cb536ae76ed5173c7e95e11312b17b))
- **receipts:** shift signature group to the right margin in e-GP PDF ([4354419](https://github.com/aegisx-platform/aegisx-starter/commit/43544199eea9d8ec85fbf622920bf55424e19d6a))
- **receipts:** tighten committee signature spacing in e-GP inspection PDF ([8b9c21c](https://github.com/aegisx-platform/aegisx-starter/commit/8b9c21ccdc905d1afdda824a6b6f0758d5037bde))
- **receipts:** tighten line height + nudge signatures right in e-GP PDF ([09224d2](https://github.com/aegisx-platform/aegisx-starter/commit/09224d24182b4708eb4c9d499fc9ed3c33a75264))
- **receipts:** widen quick-intake dialog 960 → 1200px ([fccf955](https://github.com/aegisx-platform/aegisx-starter/commit/fccf955c0ae00c0b2debf5e380591127b310f96d))
- **repo+gate:** three findings from PR [#116](https://github.com/aegisx-platform/aegisx-starter/issues/116) review — double-convert + audit drift + bypass ([5740f87](https://github.com/aegisx-platform/aegisx-starter/commit/5740f87a909188fe0c7434425ad8fcde88729fab)), closes [#109](https://github.com/aegisx-platform/aegisx-starter/issues/109)
- **repo:** wire 17 silent-drop columns through transformToDb ([#106](https://github.com/aegisx-platform/aegisx-starter/issues/106) pattern) ([acfd8ce](https://github.com/aegisx-platform/aegisx-starter/commit/acfd8ce29d399433030bfd422e3f5bf2a8e8ee57))
- **trade-creditor-register:** borderless search inputs (border-0 + appearance:none) ([6268a92](https://github.com/aegisx-platform/aegisx-starter/commit/6268a926fd5bc7436c2c0160645b3d5a3eb911f8))
- **trade-creditor-register:** canvas checkbox + numeric BE date in PDF ([ed84778](https://github.com/aegisx-platform/aegisx-starter/commit/ed84778987233d05401f8a3e040036e16f026e96))
- **trade-creditor-register:** import MatProgressSpinnerModule in fund-category dialog ([c283d80](https://github.com/aegisx-platform/aegisx-starter/commit/c283d8002181d26028f58b9d91c4e5abec4647e0))
- **trade-creditor-register:** tighten FE request types (nullable fund + item edits) ([964887c](https://github.com/aegisx-platform/aegisx-starter/commit/964887cb0a77172712e707fd359664fef52d4e60))
- **web/numbering:** address PR [#90](https://github.com/aegisx-platform/aegisx-starter/issues/90) code review issues 2-6 ([9242e0f](https://github.com/aegisx-platform/aegisx-starter/commit/9242e0f50067bde585d2c3b6938fd78369deaf45))
- **web:** chart-color re-resolves --ax tokens on theme switch ([c83ef1c](https://github.com/aegisx-platform/aegisx-starter/commit/c83ef1c36e998a3336eb85ef3f823da6bc152b4b))
- **web:** finish DATE-shift cleanup — disposal + drug-returns dialogs ([f679aae](https://github.com/aegisx-platform/aegisx-starter/commit/f679aaedd834b1dc93c4c97511b35f46d47a1355)), closes [#99](https://github.com/aegisx-platform/aegisx-starter/issues/99)
- **web:** finish DATE-shift cleanup + theme touched components ([fae31f7](https://github.com/aegisx-platform/aegisx-starter/commit/fae31f7a5750c12ebf35c0aeea048a9f12391491)), closes [#fallback](https://github.com/aegisx-platform/aegisx-starter/issues/fallback)
- wire 17 silent-drop fields through controller transformUpdateSchema ([c99d2f2](https://github.com/aegisx-platform/aegisx-starter/commit/c99d2f229b2e3130586fd148f2b92d4c263fe6fc))

### Features

- **.claude/skills:** add subagent-driven-strict — wrap subagent-driven with pre/post review gates ([e4dbe6b](https://github.com/aegisx-platform/aegisx-starter/commit/e4dbe6b3d6f4c40200cf045b51205e49a2b9f1f8))
- **attachments:** central <app-attachments> + migrate disposal ([5cafb04](https://github.com/aegisx-platform/aegisx-starter/commit/5cafb04a46ae708866d59dff0d2e1f59e99da2cf))
- **creditor-fund-categories:** add master lookup module for หมวดเงิน ([849ca99](https://github.com/aegisx-platform/aegisx-starter/commit/849ca9978b4765f4e2ba1dfd58ea980933358983))
- **db:** create numbering_formats, numbering_counters, numbering_audit_log ([642f982](https://github.com/aegisx-platform/aegisx-starter/commit/642f982f79c01c701c54892a48f53913590bb4de))
- **db:** relax pr/po number constraints for allocation timing + override ([2d1f379](https://github.com/aegisx-platform/aegisx-starter/commit/2d1f379e55002a8aa33373f6606918a8c5f8135f))
- **disposal:** add Garuda emblem (ครุฑ) to memo pdf header ([c4b62b1](https://github.com/aegisx-platform/aegisx-starter/commit/c4b62b117ec782b7dddbcfac647f3f1e7424502b))
- **disposal:** add memo pdf (บันทึกข้อความ) with controlled-drug aware wording ([203a048](https://github.com/aegisx-platform/aegisx-starter/commit/203a04829916ca7557556308ed9c3a7619eb5358))
- **disposal:** add tab signals + getStats integration ([d01857f](https://github.com/aegisx-platform/aegisx-starter/commit/d01857fc5a46fdbd8fee2b724408c47335af5418))
- **disposal:** add workflow methods + types to FE service ([16f5ff1](https://github.com/aegisx-platform/aegisx-starter/commit/16f5ff13bd28351979a454aaaa1b28a22fcdd3bc))
- **disposal:** allow self-approval (committee decides offline, audit logs who keyed) ([3caf0fc](https://github.com/aegisx-platform/aegisx-starter/commit/3caf0fc7cfbb229415afbe98bb119129b4cc6a93))
- **disposal:** clone-from-REJECTED seeds the create dialog ([ef30cd8](https://github.com/aegisx-platform/aegisx-starter/commit/ef30cd837c940ab4caa14813970d86dc72298381))
- **disposal:** create-dialog submit logic — DRAFT or DRAFT+submit ([d21ada4](https://github.com/aegisx-platform/aegisx-starter/commit/d21ada41a3960b609e797e7203b50729b056783c))
- **disposal:** detail page stepper + workflow banner ([a0f428f](https://github.com/aegisx-platform/aegisx-starter/commit/a0f428fa6fc646a721cce863c4436cb19131651a))
- **disposal:** edit_log migration + applyEditGate workflow helper ([8f022da](https://github.com/aegisx-platform/aegisx-starter/commit/8f022da52705f9c6bc514fa9d75530582b03758e))
- **disposal:** fe edit dialog gate + history tab + memo section ([e046149](https://github.com/aegisx-platform/aegisx-starter/commit/e046149ea7fd4c4e3882c84f447536ba8dc6fb81))
- **disposal:** item picker sub-dialog + items table in Create dialog ([e179d9a](https://github.com/aegisx-platform/aegisx-starter/commit/e179d9a21f6e34a31f8e359f454713085e80817a))
- **disposal:** kpi cards + workflow tabs on list page ([68ab20f](https://github.com/aegisx-platform/aegisx-starter/commit/68ab20f5acde21e190ffb45ea8a7413baff13660))
- **disposal:** memo PUT + edit-log GET + PDF reads new fields ([439e1ee](https://github.com/aegisx-platform/aegisx-starter/commit/439e1ee1aaa6058e3eff9e1e1b339908e7ad26e6))
- **disposal:** rebuild execute dialog with all execute fields ([31b286b](https://github.com/aegisx-platform/aegisx-starter/commit/31b286b5a53366472267f2ab6a0dfe26971187ac))
- **disposal:** rebuild reject dialog with required reason + warning banner ([16a1bfb](https://github.com/aegisx-platform/aegisx-starter/commit/16a1bfb8cdba48e4bbb047bb23f52e6b4141996f))
- **disposal:** scaffold DisposalCreateDialog header form ([d128b2d](https://github.com/aegisx-platform/aegisx-starter/commit/d128b2da5f5c17e8300974843ab8d904b23d58b7))
- **disposal:** shared L1+L2 approve dialog ([1768297](https://github.com/aegisx-platform/aegisx-starter/commit/17682974029045f05baee3ba270f4a7a73dbf33e))
- **disposal:** stepper utility — status + approvals → StepProgressItem[] ([e1af8b8](https://github.com/aegisx-platform/aegisx-starter/commit/e1af8b87a4ae38918cb0e01dc171686a843e8055))
- **disposal:** wire applyEditGate into items/header + audit log ([954f657](https://github.com/aegisx-platform/aegisx-starter/commit/954f657e57b7d334bac9333d72d5e85340ef4b9e))
- **disposal:** wire DisposalCreateDialog into list + drop CRUD template ([191b2df](https://github.com/aegisx-platform/aegisx-starter/commit/191b2df6ff7cb51416749ec0cde3dcc9d60c5cb8))
- **disposal:** wire workflow actions to Approve/Reject/Execute/Cancel dialogs ([49cc8a8](https://github.com/aegisx-platform/aegisx-starter/commit/49cc8a8711c6552dcd64bdeddda14a98c7c975fc))
- **disposal:** workflow-aware stats — by_status + disposed_value_this_month ([ba28282](https://github.com/aegisx-platform/aegisx-starter/commit/ba2828278bf640ec9005c6a958dcd9dae61d1f7a))
- **distributions:** add POST /:id/approve-and-dispense atomic endpoint ([60abe14](https://github.com/aegisx-platform/aegisx-starter/commit/60abe1414297adde3b5b474467447e84afdaaf40))
- **distributions:** add POST /:id/confirm-picked atomic reconcile ([422c1a9](https://github.com/aegisx-platform/aegisx-starter/commit/422c1a95d8aa95db58973ad6e23f6bb7d91e3fa0))
- **distributions:** add POST /bulk-approve-and-dispense ([ce0ed1e](https://github.com/aegisx-platform/aegisx-starter/commit/ce0ed1e46f74a6c6158d568ef2ebb4565fdf71ae))
- **distributions:** bulk fulfill backorders ([bdef399](https://github.com/aegisx-platform/aegisx-starter/commit/bdef399fab04e65085cb96ea86b8ba807684f53f)), closes [#88](https://github.com/aegisx-platform/aegisx-starter/issues/88)
- **distributions:** bulk pick list PDF + QR target update ([805db9d](https://github.com/aegisx-platform/aegisx-starter/commit/805db9d8666192373772befe15b1b2a6e944b5fb))
- **distributions:** dialog UX + pack rounding + pick-list PDF improvements ([bbe7393](https://github.com/aegisx-platform/aegisx-starter/commit/bbe739303b35bc0f1ce1d1900bf3aa00d1063204))
- **distributions:** picked reconcile columns + suggested_lots on detail ([6442910](https://github.com/aegisx-platform/aegisx-starter/commit/6442910ef4b5ccb8ce7189c354740ff3581ff836))
- **distributions:** shortage_action on approve API + on_hand_at_source on detail ([61741ee](https://github.com/aegisx-platform/aegisx-starter/commit/61741ee5347aeff906df0fa1f149ea506bebc629))
- **expiry-alerts:** bulk-select → สร้างใบทำลาย deep link ([6db8c9a](https://github.com/aegisx-platform/aegisx-starter/commit/6db8c9a28e33e71a27e180b3802ef1e4155464e1))
- **main-warehouse:** approve dialog with editable qty + shortage action ([4ebb1cb](https://github.com/aegisx-platform/aegisx-starter/commit/4ebb1cb82989b958b661ba5d4177c54e60f492f4))
- **main-warehouse:** bulk approve+dispense dialog + toolbar button ([a337ff2](https://github.com/aegisx-platform/aegisx-starter/commit/a337ff2d6b4b7e45d4d12ec368c9cb2d9f436083))
- **main-warehouse:** confirm-picked dialog + menu entry for DISPENSED rows ([5bb8460](https://github.com/aegisx-platform/aegisx-starter/commit/5bb84603e6619fb2bbc9fa3b3e48345f2b910e98))
- **main-warehouse:** confirmation step before /dispense cuts stock ([066949a](https://github.com/aegisx-platform/aegisx-starter/commit/066949a014b704137fdaf91d20492b4c70e22a05))
- **main-warehouse:** mobile picker confirm page + route ([194f0f7](https://github.com/aegisx-platform/aegisx-starter/commit/194f0f7f074e44cc51ea1571f05823fdda11b374))
- **main-warehouse:** row click jumps PENDING straight to approve dialog ([3b39e84](https://github.com/aegisx-platform/aegisx-starter/commit/3b39e8449fc5a37173954f51dd0693012cfd7da3)), closes [#86](https://github.com/aegisx-platform/aegisx-starter/issues/86) [#86](https://github.com/aegisx-platform/aegisx-starter/issues/86)
- **main-warehouse:** scanner-driven confirm-picked workflow ([8a23bfe](https://github.com/aegisx-platform/aegisx-starter/commit/8a23bfe16695180d6c52fc742fea6014e8a6f916))
- **main-warehouse:** snackbar action shortcut to "ปฏิเสธทั้งใบ" on OUT_OF_STOCK ([8f2ef27](https://github.com/aegisx-platform/aegisx-starter/commit/8f2ef27b385756daebb8f57def0ee0f14d8dc1aa)), closes [#1](https://github.com/aegisx-platform/aegisx-starter/issues/1)
- **main-warehouse:** unified approve+dispense dialog ([9d94d32](https://github.com/aegisx-platform/aegisx-starter/commit/9d94d3222386e47945d91f5dd51da4eabb558d52))
- **numbering:** allocate() with FOR UPDATE counter + lazy seed from legacy data ([1dfcbfd](https://github.com/aegisx-platform/aegisx-starter/commit/1dfcbfdc3f0bdab52dbf3aa9a08807929b885ffc))
- **numbering:** audit trail on submit-time allocation + admin seed ([f9cc038](https://github.com/aegisx-platform/aegisx-starter/commit/f9cc038e4d585bfd1ae497fe89cceb9dce531bb2))
- **numbering:** backend override support for PR/PO create ([4b08332](https://github.com/aegisx-platform/aegisx-starter/commit/4b08332c558b6afdf3e54ddb6f46b7266553a25f))
- **numbering:** compile/parse round-trip between tokens and pattern ([793b418](https://github.com/aegisx-platform/aegisx-starter/commit/793b4189a601091e2d477ff3d8a63b45d99a03e7))
- **numbering:** controller + routes + plugin registration ([b696bc9](https://github.com/aegisx-platform/aegisx-starter/commit/b696bc9a8dfe79295f0a1cc48f84be13bc3d0177))
- **numbering:** derive period_key and render period prefix for backfill ([f9297fb](https://github.com/aegisx-platform/aegisx-starter/commit/f9297fb477a1e8e220f7abf76d0a4b213987814f))
- **numbering:** overrideNumber, resetCounter, previewNext ([eb496ba](https://github.com/aegisx-platform/aegisx-starter/commit/eb496ba84795934f0101b92c6edf76e8f7bd08d3))
- **numbering:** pattern renderer with year/month/counter tokens ([afb3e5a](https://github.com/aegisx-platform/aegisx-starter/commit/afb3e5a1e4303166e5e61103366c292c0f804d13))
- **numbering:** repository with FOR UPDATE counter lock + audit writer ([2215213](https://github.com/aegisx-platform/aegisx-starter/commit/2215213d68efad313bf29f37fe12ac9aa5b24b77))
- **numbering:** typebox schemas for formats, counter reset, audit, override ([a6a0efa](https://github.com/aegisx-platform/aegisx-starter/commit/a6a0efa167f4466c93814508bf5739f5a637bb65))
- **numbering:** types and token primitives ([07adada](https://github.com/aegisx-platform/aegisx-starter/commit/07adadaf7c49fd23dab2a61ac1cf036f8d0e15e5))
- **po:** cancel audit trail — stop dropping cancelled_by + notes clobber ([720c34d](https://github.com/aegisx-platform/aegisx-starter/commit/720c34d8b3b99adbd496e26ad6bda728422651a1)), closes [#104](https://github.com/aegisx-platform/aegisx-starter/issues/104)
- **po:** use NumberingService with fallback to generatePONumber() ([2d2d824](https://github.com/aegisx-platform/aegisx-starter/commit/2d2d8243279a4d574c49cfa22395672fdabc54ad))
- **procurement:** datepicker + editable reference in GFMIS workflow form ([7f17c49](https://github.com/aegisx-platform/aegisx-starter/commit/7f17c499e926b146381466756be3312d4e12d5a9))
- **pr:** use NumberingService with fallback to generatePRNumber() ([5821edb](https://github.com/aegisx-platform/aegisx-starter/commit/5821edb1729a60e333cfbc47762b68b152511dbc))
- **purchase-orders:** เพิ่มรายงานผลตรวจรับ+ขออนุมัติเบิกจ่าย (PO ที่มีสัญญา) ([7be714d](https://github.com/aegisx-platform/aegisx-starter/commit/7be714d89f0946fc8bcd5e6743f8fe2facff50de))
- **purchase-orders:** เพิ่มเลขที่คำสั่งคณะกรรมการในรายงานตรวจรับฯ (กรอกเอง) ([3a035b1](https://github.com/aegisx-platform/aegisx-starter/commit/3a035b15877711e81674780f583835d38fe25484))
- **purchase-orders:** เพิ่มเลขหนังสือ/ฝากคลัง/วันส่งมอบ ในรายงานตรวจรับฯ (slice 2) ([2622d19](https://github.com/aegisx-platform/aegisx-starter/commit/2622d19d42d966e028b8c03ba2a5c4c578213120))
- **purchase-orders:** รายงานตรวจรับฯ — เด้ง form เฉพาะตอนยังไม่ตั้งค่า + ปุ่มแก้ไขในหน้าปริ้น ([6882846](https://github.com/aegisx-platform/aegisx-starter/commit/6882846a87d4b0e395fea568fc9c7d3e3aba9a4c))
- **purchase-orders:** เรียน(addressee) ในรายงานตรวจรับฯ อ่านจาก head_of_agency snapshot ([bc0194b](https://github.com/aegisx-platform/aegisx-starter/commit/bc0194b3cf74266d712b2f7afef33c6b4049bb8c))
- **purchase-requests:** แก้ไขสถานะ workflow ได้ + วันที่อ้างอิงเป็น datepicker ([b7aca73](https://github.com/aegisx-platform/aegisx-starter/commit/b7aca7324745c9f1e6fb284ab5bc7d0746567d41))
- **purchase-requests:** ปรับข้อความ workflow ขั้นตอนจัดซื้อให้ชัดขึ้น ([ddce505](https://github.com/aegisx-platform/aegisx-starter/commit/ddce5055a94c5c87169dac05a2077ede36ecd16b))
- **rbac:** grant hospitals:read to inventory-admin ([b86f18d](https://github.com/aegisx-platform/aegisx-starter/commit/b86f18d6f1a2bf4d9510562337528f85b8f7b0ca))
- **receipts:** add e-GP inspection form PDF + print button on detail ([b033a02](https://github.com/aegisx-platform/aegisx-starter/commit/b033a02482a200e9ca04e677979d465b4f6c45ae))
- **receipts:** add print buttons to receipt list action menu ([8cad784](https://github.com/aegisx-platform/aegisx-starter/commit/8cad78449a9352c962d44c719273f6cacc3565a0))
- **receipts:** add vendor_name column for Non-PO receipts ([635c63a](https://github.com/aegisx-platform/aegisx-starter/commit/635c63a7a80332d6ca071c537fe5a56f6e30d418))
- **receipts:** edit-dialog polish for quick-intake continuation ([320cda1](https://github.com/aegisx-platform/aegisx-starter/commit/320cda1f82cb2986ffae50a6400a05b725b00d05))
- **receipts:** expose items_count in list response ([252192b](https://github.com/aegisx-platform/aegisx-starter/commit/252192bafde7ce4a446dbd3318b999f65500cdd1))
- **receipts:** extend stats with pending_details count ([e53aca7](https://github.com/aegisx-platform/aegisx-starter/commit/e53aca7db7bd5dd8fc8f68f1534c3ca19bde5e66))
- **receipts:** quick-filter tabs + split-button create on list ([95a3964](https://github.com/aegisx-platform/aegisx-starter/commit/95a39644acfec34cc671ffd1625b31ddacfbfbe8))
- **receipts:** quick-intake 2-column layout with per-line qty capture ([cb55b4e](https://github.com/aegisx-platform/aegisx-starter/commit/cb55b4ee8d9387890e51e6fae43fa0282969df17))
- **receipts:** scaffold quick-intake dialog (header-only DRAFT) ([24bd3a0](https://github.com/aegisx-platform/aegisx-starter/commit/24bd3a0ff7b188c7cfdeaba202a9173671a16ade))
- **trade-creditor-register:** add launcher card in procurement (เอกสารจัดซื้อ) ([56f09fc](https://github.com/aegisx-platform/aegisx-starter/commit/56f09fc1dc5c9d79bd298754b1e256e3456fbcb1))
- **trade-creditor-register:** editable FINALIZED with elevated permission + audit log ([909b690](https://github.com/aegisx-platform/aegisx-starter/commit/909b6909f275cf94bf0f7be297ec4759b4b9b4bb))
- **trade-creditor-register:** fe edit finalized (permission-gated) + edit history ([c9641ca](https://github.com/aegisx-platform/aegisx-starter/commit/c9641ca596f866820e75b3a8722169e9ac126880))
- **trade-creditor-register:** frontend create flow + detail/print/finalize/void ([629f3cf](https://github.com/aegisx-platform/aegisx-starter/commit/629f3cff95a9a6281288e302dcadcb52fd107b95))
- **trade-creditor-register:** frontend list, stats, settings + nav ([b5796c1](https://github.com/aegisx-platform/aegisx-starter/commit/b5796c1987adbd21e054d3cd6e68ddbab01fd8e2))
- **trade-creditor-register:** seed RBAC permissions + role grants ([a77bca1](https://github.com/aegisx-platform/aegisx-starter/commit/a77bca1984322d1891dbf2ca58d01beeef372fe1))
- **trade-creditor-register:** service, routes, controller + PDF report ([559f217](https://github.com/aegisx-platform/aegisx-starter/commit/559f2173d10ee2433d789a7b016dea1e607777cb))
- **trade-creditor-register:** tables + schemas + repository ([4365390](https://github.com/aegisx-platform/aegisx-starter/commit/4365390b49d0a73e22b6a0124a282357eb8062e1))
- **web/numbering:** admin API service (signals/firstValueFrom) ([3f41d95](https://github.com/aegisx-platform/aegisx-starter/commit/3f41d95d0c75b6a9fa0e3fc6ffdca9bc89c79218))
- **web/numbering:** audit tab (read-only listing) ([5c20ae6](https://github.com/aegisx-platform/aegisx-starter/commit/5c20ae64a206002ced0bb5990515c6878b3d9edc))
- **web/numbering:** counter tab + reset dialog ([b62f403](https://github.com/aegisx-platform/aegisx-starter/commit/b62f403a614dedeaf2a6dc54d8ac2ac46d9b2bf4))
- **web/numbering:** edit page + Builder tab + F4/F5 tab stubs ([b601dd4](https://github.com/aegisx-platform/aegisx-starter/commit/b601dd451dae231c5ec3eae94386bda221215483))
- **web/numbering:** format list page + route registration ([8b291ae](https://github.com/aegisx-platform/aegisx-starter/commit/8b291aed5a6227177fee24cc069823a104b1f0b9))
- **web/pr:** override-number dialog and integration into PR create form ([de3cb42](https://github.com/aegisx-platform/aegisx-starter/commit/de3cb42ca3ba26949b2a041d2618f825d39746f1))
- **web:** add document-numbering menu entries to portal + system shell ([86a5848](https://github.com/aegisx-platform/aegisx-starter/commit/86a58489725e25480153be2a8ce3acbd89205a43)), closes [#90](https://github.com/aegisx-platform/aegisx-starter/issues/90)
- **web:** resolve stockcard chart colour from --ax token at runtime ([58da3d8](https://github.com/aegisx-platform/aegisx-starter/commit/58da3d803610e05286f9e5c47119df8ceebc7721)), closes [#2563eb](https://github.com/aegisx-platform/aegisx-starter/issues/2563eb)
- **web:** settings page — hospital search autocomplete from platform.hospitals ([0192064](https://github.com/aegisx-platform/aegisx-starter/commit/0192064f38c22a2721df42f40a5f21b692e68e4d))
